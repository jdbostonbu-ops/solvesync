 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ye=new $s("@firebase/app"),xa="@firebase/app-compat",ka="@firebase/analytics-compat",Ma="@firebase/analytics",Pa="@firebase/app-check-compat",Da="@firebase/app-check",Oa="@firebase/auth",La="@firebase/auth-compat",Fa="@firebase/database",Ba="@firebase/data-connect",Wa="@firebase/database-compat",Ua="@firebase/functions",Ha="@firebase/functions-compat",Va="@firebase/installations",$a="@firebase/installations-compat",Ga="@firebase/messaging",za="@firebase/messaging-compat",ja="@firebase/performance",qa="@firebase/performance-compat",Ya="@firebase/remote-config",Ka="@firebase/remote-config-compat",Qa="@firebase/storage",Xa="@firebase/storage-compat",Ja="@firebase/firestore",Za="@firebase/ai",el="@firebase/firestore-compat",tl="firebase",nl="11.10.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Mt;class br extends on{static get __EMPTY_NODE(){return Mt}static set __EMPTY_NODE(e){Mt=e}compare(e,t){return Je(e.name,t.name)}isDefinedOn(e){throw Qe("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return S.MIN}maxPost(){return new S(Oe,Mt)}makePost(e,t){return p(typeof e=="string","KeyIndex indexValue must always be a string."),new S(e,Mt)}toString(){return".key"}}const $e=new br;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kc extends on{compare(e,t){const i=e.node.compareTo(t.node);return i===0?Je(e.name,t.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return S.MIN}maxPost(){return S.MAX}makePost(e,t){const i=j(e);return new S(t,i)}toString(){return".value"}}const Mc=new kc;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
