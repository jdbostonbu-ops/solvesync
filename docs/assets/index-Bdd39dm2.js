 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const p=function(n,e){if(!n)throw Xe(e)},Xe=function(n){return new Error("Firebase Database ("+xs.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Po(n){return Ps(void 0,n)}function Ps(n,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const t=e;return new Date(t.getTime());case Object:n===void 0&&(n={});break;case Array:n=[];break;default:return e}for(const t in e)!e.hasOwnProperty(t)||!Oo(t)||(n[t]=Ps(n[t],e[t]));return n}function Oo(n){return n!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vo(n,e){if(n.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const t={alg:"none",type:"JWT"},i=e||"demo-project",s=n.iat||0,r=n.sub||n.user_id;if(!r)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const o=Object.assign({iss:`https://securetoken.google.com/${i}`,aud:i,iat:s,exp:s+3600,auth_time:s,sub:r,user_id:r,firebase:{sign_in_provider:"custom",identities:{}}},n);return[Lt(JSON.stringify(t)),Lt(JSON.stringify(o)),""].join(".")}const at={};function Go(){const n={prod:[],emulator:[]};for(const e of Object.keys(at))at[e]?n.emulator.push(e):n.prod.push(e);return n}function zo(n){let e=document.getElementById(n),t=!1;return e||(e=document.createElement("div"),e.setAttribute("id",n),t=!0),{created:t,element:e}}let Di=!1;function jo(n,e){if(typeof window>"u"||typeof document>"u"||!zn(window.location.host)||at[n]===e||at[n]||Di)return;at[n]=e;function t(d){return`__firebase__banner__${d}`}const i="__firebase__banner",r=Go().prod.length>0;function o(){const d=document.getElementById(i);d&&d.remove()}function a(d){d.style.display="flex",d.style.background="#7faaf0",d.style.position="fixed",d.style.bottom="5px",d.style.left="5px",d.style.padding=".5em",d.style.borderRadius="5px",d.style.alignItems="center"}function l(d,m){d.setAttribute("width","24"),d.setAttribute("id",m),d.setAttribute("height","24"),d.setAttribute("viewBox","0 0 24 24"),d.setAttribute("fill","none"),d.style.marginLeft="-6px"}function c(){const d=document.createElement("span");return d.style.cursor="pointer",d.style.marginLeft="16px",d.style.fontSize="24px",d.innerHTML=" &times;",d.onclick=()=>{Di=!0,o()},d}function f(d,m){d.setAttribute("id",m),d.innerText="Learn more",d.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",d.setAttribute("target","__blank"),d.style.paddingLeft="5px",d.style.textDecoration="underline"}function u(){const d=zo(i),m=t("text"),g=document.getElementById(m)||document.createElement("span"),x=t("learnmore"),w=document.getElementById(x)||document.createElement("a"),ne=t("preprendIcon"),ie=document.getElementById(ne)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(d.created){const se=d.element;a(se),f(w,x);const nt=c();l(ie,ne),se.append(ie,g,w,nt),document.body.appendChild(se)}r?(g.innerText="Preview backend disconnected.",ie.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jo="FirebaseError";class It extends Error{constructor(e,t,i){super(t),this.code=e,this.customData=i,this.name=Jo,Object.setPrototypeOf(this,It.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Bs.prototype.create)}}class Bs{constructor(e,t,i){this.service=e,this.serviceName=t,this.errors=i}create(e,...t){const i=t[0]||{},s=`${this.service}/${e}`,r=this.errors[e],o=r?Zo(r,i):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new It(s,a,i)}}function Zo(n,e){return n.replace(ea,(t,i)=>{const s=e[i];return s!=null?String(s):`<${i}?>`})}const ea=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ws=function(n){let e={},t={},i={},s="";try{const r=n.split(".");e=ft(Nn(r[0])||""),t=ft(Nn(r[1])||""),s=r[2],i=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:i,signature:s}},ta=function(n){const e=Ws(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},na=function(n){const e=Ws(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ge=new Us("@firebase/app"),Na="@firebase/app-compat",Ra="@firebase/analytics-compat",Aa="@firebase/analytics",Ma="@firebase/app-check-compat",xa="@firebase/app-check",ka="@firebase/auth",Da="@firebase/auth-compat",Pa="@firebase/database",Oa="@firebase/data-connect",La="@firebase/database-compat",Fa="@firebase/functions",Ba="@firebase/functions-compat",Wa="@firebase/installations",Ua="@firebase/installations-compat",$a="@firebase/messaging",Ha="@firebase/messaging-compat",Va="@firebase/performance",Ga="@firebase/performance-compat",za="@firebase/remote-config",ja="@firebase/remote-config-compat",qa="@firebase/storage",Ya="@firebase/storage-compat",Ka="@firebase/firestore",Qa="@firebase/ai",Xa="@firebase/firestore-compat",Ja="firebase",Za="11.10.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xn="[DEFAULT]",el={[Mn]:"fire-core",[Na]:"fire-core-compat",[Aa]:"fire-analytics",[Ra]:"fire-analytics-compat",[xa]:"fire-app-check",[Ma]:"fire-app-check-compat",[ka]:"fire-auth",[Da]:"fire-auth-compat",[Pa]:"fire-rtdb",[Oa]:"fire-data-connect",[La]:"fire-rtdb-compat",[Fa]:"fire-fn",[Ba]:"fire-fn-compat",[Wa]:"fire-iid",[Ua]:"fire-iid-compat",[$a]:"fire-fcm",[Ha]:"fire-fcm-compat",[Va]:"fire-perf",[Ga]:"fire-perf-compat",[za]:"fire-rc",[ja]:"fire-rc-compat",[qa]:"fire-gcs",[Ya]:"fire-gcs-compat",[Ka]:"fire-fst",[Xa]:"fire-fst-compat",[Qa]:"fire-vertex","fire-js":"fire-js",[Ja]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wt=new Map,tl=new Map,kn=new Map;function Ui(n,e){try{n.container.addComponent(e)}catch(t){ge.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function Ut(n){const e=n.name;if(kn.has(e))return ge.debug(`There were multiple attempts to register component ${e}.`),!1;kn.set(e,n);for(const t of Wt.values())Ui(t,n);for(const t of tl.values())Ui(t,n);return!0}function nl(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function il(n){return n==null?!1:n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ol=Za;function Vs(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const i=Object.assign({name:xn,automaticDataCollectionEnabled:!0},e),s=i.name;if(typeof s!="string"||!s)throw be.create("bad-app-name",{appName:String(s)});if(t||(t=Ls()),!t)throw be.create("no-options");const r=Wt.get(s);if(r){if(Bt(t,r.options)&&Bt(i,r.config))return r;throw be.create("duplicate-app",{appName:s})}const o=new ca(s);for(const l of kn.values())o.addComponent(l);const a=new rl(t,i,o);return Wt.set(s,a),a}function al(n=xn){const e=Wt.get(n);if(!e&&n===xn&&Ls())return Vs();if(!e)throw be.create("no-app",{appName:n});return e}function Ve(n,e,t){var i;let s=(i=el[n])!==null&&i!==void 0?i:n;t&&(s+=`-${t}`);const r=s.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${s}" with version "${e}":`];r&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),ge.warn(a.join(" "));return}Ut(new _t(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ll="firebase-heartbeat-database",cl=1,pt="firebase-heartbeat-store";let vn=null;function Gs(){return vn||(vn=wa(ll,cl,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(pt)}catch(t){console.warn(t)}}}}).catch(n=>{throw be.create("idb-open",{originalErrorMessage:n.message})})),vn}async function hl(n){try{const t=(await Gs()).transaction(pt),i=await t.objectStore(pt).get(zs(n));return await t.done,i}catch(e){if(e instanceof It)ge.warn(e.message);else{const t=be.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});ge.warn(t.message)}}}async function $i(n,e){try{const i=(await Gs()).transaction(pt,"readwrite");await i.objectStore(pt).put(e,zs(n)),await i.done}catch(t){if(t instanceof It)ge.warn(t.message);else{const i=be.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});ge.warn(i.message)}}}function zs(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gl(n){Ut(new _t("platform-logger",e=>new Sa(e),"PRIVATE")),Ut(new _t("heartbeat",e=>new fl(e),"PRIVATE")),Ve(Mn,Wi,n),Ve(Mn,Wi,"esm2017"),Ve("fire-js","")}gl("");var yl="firebase",vl="11.10.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Ve(yl,vl,"app");var Gi={};const zi="@firebase/database",ji="1.0.20";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wl{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return ve(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ge=new Us("@firebase/database"),Il=function(){let n=1;return function(){return n++}}(),Ys=function(n){const e=ra(n),t=new sa;t.update(e);const i=t.digest();return Gn.encodeByteArray(i)},St=function(...n){let e="";for(let t=0;t<n.length;t++){const i=n[t];Array.isArray(i)||i&&typeof i=="object"&&typeof i.length=="number"?e+=St.apply(null,i):typeof i=="object"?e+=H(i):e+=i,e+=" "}return e};let lt=null,qi=!0;const Sl=function(n,e){p(!0,"Can't turn on custom loggers persistently."),Ge.logLevel=O.VERBOSE,lt=Ge.log.bind(Ge)},Y=function(...n){if(qi===!0&&(qi=!1,lt===null&&bl.get("logging_enabled")===!0&&Sl()),lt){const e=St.apply(null,n);lt(e)}},Tt=function(n){return function(...e){Y(n,...e)}},Dn=function(...n){const e="FIREBASE INTERNAL ERROR: "+St(...n);Ge.error(e)},ye=function(...n){const e=`FIREBASE FATAL ERROR: ${St(...n)}`;throw Ge.error(e),new Error(e)},ee=function(...n){const e="FIREBASE WARNING: "+St(...n);Ge.warn(e)},Tl=function(){typeof window<"u"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&ee("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},Ks=function(n){return typeof n=="number"&&(n!==n||n===Number.POSITIVE_INFINITY||n===Number.NEGATIVE_INFINITY)},Nl=function(n){if(document.readyState==="complete")n();else{let e=!1;const t=function(){if(!document.body){setTimeout(t,Math.floor(10));return}e||(e=!0,n())};document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&t()}),window.attachEvent("onload",t))}},Ye="[MIN_NAME]",Oe="[MAX_NAME]",Ze=function(n,e){if(n===e)return 0;if(n===Ye||e===Oe)return-1;if(e===Ye||n===Oe)return 1;{const t=Yi(n),i=Yi(e);return t!==null?i!==null?t-i===0?n.length-e.length:t-i:-1:i!==null?1:n<e?-1:1}},Rl=function(n,e){return n===e?0:n<e?-1:1},it=function(n,e){if(e&&n in e)return e[n];throw new Error("Missing required key ("+n+") in object: "+H(e))},Yn=function(n){if(typeof n!="object"||n===null)return H(n);const e=[];for(const i in n)e.push(i);e.sort();let t="{";for(let i=0;i<e.length;i++)i!==0&&(t+=","),t+=H(e[i]),t+=":",t+=Yn(n[e[i]]);return t+="}",t},Qs=function(n,e){const t=n.length;if(t<=e)return[n];const i=[];for(let s=0;s<t;s+=e)s+e>t?i.push(n.substring(s,t)):i.push(n.substring(s,s+e));return i};function te(n,e){for(const t in n)n.hasOwnProperty(t)&&e(t,n[t])}const Xs=function(n){p(!Ks(n),"Invalid JSON number");const e=11,t=52,i=(1<<e-1)-1;let s,r,o,a,l;n===0?(r=0,o=0,s=1/n===-1/0?1:0):(s=n<0,n=Math.abs(n),n>=Math.pow(2,1-i)?(a=Math.min(Math.floor(Math.log(n)/Math.LN2),i),r=a+i,o=Math.round(n*Math.pow(2,t-a)-Math.pow(2,t))):(r=0,o=Math.round(n/Math.pow(2,1-i-t))));const c=[];for(l=t;l;l-=1)c.push(o%2?1:0),o=Math.floor(o/2);for(l=e;l;l-=1)c.push(r%2?1:0),r=Math.floor(r/2);c.push(s?1:0),c.reverse();const f=c.join("");let u="";for(l=0;l<64;l+=8){let d=parseInt(f.substr(l,8),2).toString(16);d.length===1&&(d="0"+d),u=u+d}return u.toLowerCase()},Al=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},Ml=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function xl(n,e){let t="Unknown Error";n==="too_big"?t="The data requested exceeds the maximum size that can be accessed with a single request.":n==="permission_denied"?t="Client doesn't have permission to access the desired data.":n==="unavailable"&&(t="The service is unavailable");const i=new Error(n+" at "+e._path.toString()+": "+t);return i.code=n.toUpperCase(),i}const kl=new RegExp("^-?(0*)\\d{1,10}$"),Dl=-2147483648,Pl=2147483647,Yi=function(n){if(kl.test(n)){const e=Number(n);if(e>=Dl&&e<=Pl)return e}return null},et=function(n){try{n()}catch(e){setTimeout(()=>{const t=e.stack||"";throw ee("Exception was thrown by user callback.",t),e},Math.floor(0))}},Ol=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},ct=function(n,e){const t=setTimeout(n,e);return typeof t=="number"&&typeof Deno<"u"&&Deno.unrefTimer?Deno.unrefTimer(t):typeof t=="object"&&t.unref&&t.unref(),t};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kn="5",Js="v",Zs="s",er="r",tr="f",nr=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,ir="ls",sr="p",Pn="ac",rr="websocket",or="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wl{constructor(){this.counters_={}}incrementCounter(e,t=1){ve(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return Po(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $l{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const i=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let s=0;s<i.length;++s)i[s]&&et(()=>{this.onMessage_(i[s])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sn{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const i=new T(Ye,e),s=new T(Ye,t);return this.compare(i,s)!==0}minPost(){return T.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let kt;class Cr extends sn{static get __EMPTY_NODE(){return kt}static set __EMPTY_NODE(e){kt=e}compare(e,t){return Ze(e.name,t.name)}isDefinedOn(e){throw Xe("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return T.MIN}maxPost(){return new T(Oe,kt)}makePost(e,t){return p(typeof e=="string","KeyIndex indexValue must always be a string."),new T(e,kt)}toString(){return".key"}}const ze=new Cr;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yc(n,e){return Ze(n.name,e.name)}function ei(n,e){return Ze(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let On;function vc(n){On=n}const Er=function(n){return typeof n=="number"?"number:"+Xs(n):"string:"+n},wr=function(n){if(n.isLeafNode()){const e=n.val();p(typeof e=="string"||typeof e=="number"||typeof e=="object"&&ve(e,".sv"),"Priority must be a string or number.")}else p(n===On||n.isEmpty(),"priority of unexpected type.");p(n===On||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let br,Ir;function Cc(n){br=n}function Ec(n){Ir=n}class wc extends sn{compare(e,t){const i=e.node.getPriority(),s=t.node.getPriority(),r=i.compareTo(s);return r===0?Ze(e.name,t.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return T.MIN}maxPost(){return new T(Oe,new G("[PRIORITY-POST]",Ir))}makePost(e,t){const i=br(e);return new T(t,new G("[PRIORITY-POST]",i))}toString(){return".priority"}}const $=new wc;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bc=Math.log(2);class Ic{constructor(e){const t=r=>parseInt(Math.log(r)/bc,10),i=r=>parseInt(Array(r+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const s=i(this.count);this.bits_=e+1&s}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Vt=function(n,e,t,i){n.sort(e);const s=function(l,c){const f=c-l;let u,d;if(f===0)return null;if(f===1)return u=n[l],d=t?t(u):u,new z(d,u.node,z.BLACK,null,null);{const m=parseInt(f/2,10)+l,g=s(l,m),x=s(m+1,c);return u=n[m],d=t?t(u):u,new z(d,u.node,z.BLACK,g,x)}},r=function(l){let c=null,f=null,u=n.length;const d=function(g,x){const w=u-g,ne=u;u-=g;const ie=s(w+1,ne),se=n[w],nt=t?t(se):se;m(new z(nt,se.node,x,null,ie))},m=function(g){c?(c.left=g,c=g):(f=g,c=g)};for(let g=0;g<l.count;++g){const x=l.nextBitIsOne(),w=Math.pow(2,l.count-(g+1));x?d(w,z.BLACK):(d(w,z.BLACK),d(w,z.RED))}return f},o=new Ic(n.length),a=r(o);return new X(i||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let bn;const Ue={};class _e{static get Default(){return p(Ue&&$,"ChildrenNode.ts has not been loaded"),bn=bn||new _e({".priority":Ue},{".priority":$}),bn}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=qe(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof X?t:null}hasIndex(e){return ve(this.indexSet_,e.toString())}addIndex(e,t){p(e!==ze,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let s=!1;const r=t.getIterator(T.Wrap);let o=r.getNext();for(;o;)s=s||e.isDefinedOn(o.node),i.push(o),o=r.getNext();let a;s?a=Vt(i,e.getCompare()):a=Ue;const l=e.toString(),c=Object.assign({},this.indexSet_);c[l]=e;const f=Object.assign({},this.indexes_);return f[l]=a,new _e(f,c)}addToIndexes(e,t){const i=Ft(this.indexes_,(s,r)=>{const o=qe(this.indexSet_,r);if(p(o,"Missing index implementation for "+r),s===Ue)if(o.isDefinedOn(e.node)){const a=[],l=t.getIterator(T.Wrap);let c=l.getNext();for(;c;)c.name!==e.name&&a.push(c),c=l.getNext();return a.push(e),Vt(a,o.getCompare())}else return Ue;else{const a=t.get(e.name);let l=s;return a&&(l=l.remove(new T(e.name,a))),l.insert(e,e.node)}});return new _e(i,this.indexSet_)}removeFromIndexes(e,t){const i=Ft(this.indexes_,s=>{if(s===Ue)return s;{const r=t.get(e.name);return r?s.remove(new T(e.name,r)):s}});return new _e(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rc extends sn{compare(e,t){const i=e.node.compareTo(t.node);return i===0?Ze(e.name,t.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return T.MIN}maxPost(){return T.MAX}makePost(e,t){const i=j(e);return new T(t,i)}toString(){return".value"}}const Ac=new Rc;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sr(n){return{type:"value",snapshotNode:n}}function Ke(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function gt(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function yt(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function Mc(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ti{constructor(e){this.index_=e}updateChild(e,t,i,s,r,o){p(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(s).equals(i.getChild(s))&&a.isEmpty()===i.isEmpty()||(o!=null&&(i.isEmpty()?e.hasChild(t)?o.trackChildChange(gt(t,a)):p(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(Ke(t,i)):o.trackChildChange(yt(t,i,a))),e.isLeafNode()&&i.isEmpty())?e:e.updateImmediateChild(t,i).withIndex(this.index_)}updateFullNode(e,t,i){return i!=null&&(e.isLeafNode()||e.forEachChild($,(s,r)=>{t.hasChild(s)||i.trackChildChange(gt(s,r))}),t.isLeafNode()||t.forEachChild($,(s,r)=>{if(e.hasChild(s)){const o=e.getImmediateChild(s);o.equals(r)||i.trackChildChange(yt(s,r,o))}else i.trackChildChange(Ke(s,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?v.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gt extends _r{reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return t!==void 0?"tag$"+t:(p(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}constructor(e,t,i,s){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=i,this.appCheckTokenProvider_=s,this.log_=Tt("p:rest:"),this.listens_={}}listen(e,t,i,s){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const o=Gt.getListenId_(e,i),a={};this.listens_[o]=a;const l=as(e._queryParams);this.restRequest_(r+".json",l,(c,f)=>{let u=f;if(c===404&&(u=null,c=null),c===null&&this.onDataUpdate_(r,u,!1,i),qe(this.listens_,o)===a){let d;c?c===401?d="permission_denied":d="rest_error:"+c:d="ok",s(d,null)}})}unlisten(e,t){const i=Gt.getListenId_(e,t);delete this.listens_[i]}get(e){const t=as(e._queryParams),i=e._path.toString(),s=new tn;return this.restRequest_(i+".json",t,(r,o)=>{let a=o;r===404&&(a=null,r=null),r===null?(this.onDataUpdate_(i,a,!1,null),s.resolve(a)):s.reject(new Error(a))}),s.promise}refreshAuthToken(e){}restRequest_(e,t={},i){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([s,r])=>{s&&s.accessToken&&(t.auth=s.accessToken),r&&r.token&&(t.ac=r.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+ia(t);this.log_("Sending REST request for "+o);const a=new XMLHttpRequest;a.onreadystatechange=()=>{if(i&&a.readyState===4){this.log_("REST Response for "+o+" received. status:",a.status,"response:",a.responseText);let l=null;if(a.status>=200&&a.status<300){try{l=ft(a.responseText)}catch{ee("Failed to parse JSON response for "+o+": "+a.responseText)}i(null,l)}else a.status!==401&&a.status!==404&&ee("Got unsuccessful REST response for "+o+" Status: "+a.status),i(a.status);i=null}},a.open("GET",o,!0),a.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dc{constructor(){this.rootNode_=v.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zt(){return{value:null,children:new Map}}function Tr(n,e,t){if(N(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const i=S(e);n.children.has(i)||n.children.set(i,zt());const s=n.children.get(i);e=L(e),Tr(s,e,t)}}function Ln(n,e,t){n.value!==null?t(e,n.value):Pc(n,(i,s)=>{const r=new D(e.toString()+"/"+i);Ln(s,r,t)})}function Pc(n,e){n.children.forEach((t,i)=>{e(i,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cs=10*1e3,Lc=30*1e3,Fc=5*60*1e3;class Bc{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Oc(e);const i=cs+(Lc-cs)*Math.random();ct(this.reportStats_.bind(this),Math.floor(i))}reportStats_(){const e=this.statsListener_.get(),t={};let i=!1;te(e,(s,r)=>{r>0&&ve(this.statsToReport_,s)&&(t[s]=r,i=!0)}),i&&this.server_.reportStats(t),ct(this.reportStats_.bind(this),Math.floor(Math.random()*2*Fc))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jt{constructor(e,t,i){this.path=e,this.affectedTree=t,this.revert=i,this.type=ce.ACK_USER_WRITE,this.source=Nr()}operationForChild(e){if(N(this.path)){if(this.affectedTree.value!=null)return p(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new D(e));return new jt(k(),t,this.revert)}}else return p(S(this.path)===e,"operationForChild called for unrelated child."),new jt(L(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ct{constructor(e,t){this.source=e,this.path=t,this.type=ce.LISTEN_COMPLETE}operationForChild(e){return N(this.path)?new Ct(this.source,k()):new Ct(this.source,L(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Le{constructor(e,t,i){this.source=e,this.path=t,this.snap=i,this.type=ce.OVERWRITE}operationForChild(e){return N(this.path)?new Le(this.source,k(),this.snap.getImmediateChild(e)):new Le(this.source,L(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Et{constructor(e,t,i){this.source=e,this.path=t,this.children=i,this.type=ce.MERGE}operationForChild(e){if(N(this.path)){const t=this.children.subtree(new D(e));return t.isEmpty()?null:t.value?new Le(this.source,k(),t.value):new Et(this.source,k(),t)}else return p(S(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Et(this.source,L(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wc{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Uc(n,e,t,i){const s=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&n.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(Mc(o.childName,o.snapshotNode))}),ot(n,s,"child_removed",e,i,t),ot(n,s,"child_added",e,i,t),ot(n,s,"child_moved",r,i,t),ot(n,s,"child_changed",e,i,t),ot(n,s,"value",e,i,t),s}function ot(n,e,t,i,s,r){const o=i.filter(a=>a.type===t);o.sort((a,l)=>Hc(n,a,l)),o.forEach(a=>{const l=$c(n,a,r);s.forEach(c=>{c.respondsTo(a.type)&&e.push(c.createEvent(l,n.query_))})})}function $c(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function Hc(n,e,t){if(e.childName==null||t.childName==null)throw Xe("Should only compare child_ events.");const i=new T(e.childName,e.snapshotNode),s=new T(t.childName,t.snapshotNode);return n.index_.compare(i,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rn(n,e){return{eventCache:n,serverCache:e}}function ht(n,e,t,i){return rn(new Ne(e,t,i),n.serverCache)}function Rr(n,e,t,i){return rn(n.eventCache,new Ne(e,t,i))}function qt(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function Fe(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class he{constructor(e){this.writeTree_=e}static empty(){return new he(new B(null))}}function ut(n,e,t){if(N(e))return new he(new B(t));{const i=n.writeTree_.findRootMostValueAndPath(e);if(i!=null){const s=i.path;let r=i.value;const o=K(s,e);return r=r.updateChild(o,t),new he(n.writeTree_.set(s,r))}else{const s=new B(t),r=n.writeTree_.setTree(e,s);return new he(r)}}}function hs(n,e,t){let i=n;return te(t,(s,r)=>{i=ut(i,V(e,s),r)}),i}function us(n,e){if(N(e))return he.empty();{const t=n.writeTree_.setTree(e,new B(null));return new he(t)}}function Fn(n,e){return We(n,e)!=null}function We(n,e){const t=n.writeTree_.findRootMostValueAndPath(e);return t!=null?n.writeTree_.get(t.path).getChild(K(t.path,e)):null}function ds(n){const e=[],t=n.writeTree_.value;return t!=null?t.isLeafNode()||t.forEachChild($,(i,s)=>{e.push(new T(i,s))}):n.writeTree_.children.inorderTraversal((i,s)=>{s.value!=null&&e.push(new T(i,s.value))}),e}function Ie(n,e){if(N(e))return n;{const t=We(n,e);return t!=null?new he(new B(t)):new he(n.writeTree_.subtree(e))}}function Bn(n){return n.writeTree_.isEmpty()}function Qe(n,e){return Ar(k(),n.writeTree_,e)}function Ar(n,e,t){if(e.value!=null)return t.updateChild(n,e.value);{let i=null;return e.children.inorderTraversal((s,r)=>{s===".priority"?(p(r.value!==null,"Priority writes must always be leaf nodes"),i=r.value):t=Ar(V(n,s),r,t)}),!t.getChild(n).isEmpty()&&i!==null&&(t=t.updateChild(V(n,".priority"),i)),t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function on(n,e){return Dr(e,n)}function Gc(n,e,t,i,s){p(i>n.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),n.allWrites.push({path:e,snap:t,writeId:i,visible:s}),s&&(n.visibleWrites=ut(n.visibleWrites,e,t)),n.lastWriteId=i}function zc(n,e){for(let t=0;t<n.allWrites.length;t++){const i=n.allWrites[t];if(i.writeId===e)return i}return null}function jc(n,e){const t=n.allWrites.findIndex(a=>a.writeId===e);p(t>=0,"removeWrite called with nonexistent writeId.");const i=n.allWrites[t];n.allWrites.splice(t,1);let s=i.visible,r=!1,o=n.allWrites.length-1;for(;s&&o>=0;){const a=n.allWrites[o];a.visible&&(o>=t&&qc(a,i.path)?s=!1:le(i.path,a.path)&&(r=!0)),o--}if(s){if(r)return Yc(n),!0;if(i.snap)n.visibleWrites=us(n.visibleWrites,i.path);else{const a=i.children;te(a,l=>{n.visibleWrites=us(n.visibleWrites,V(i.path,l))})}return!0}else return!1}function qc(n,e){if(n.snap)return le(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&le(V(n.path,t),e))return!0;return!1}function Yc(n){n.visibleWrites=Mr(n.allWrites,Kc,k()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function Kc(n){return n.visible}function Mr(n,e,t){let i=he.empty();for(let s=0;s<n.length;++s){const r=n[s];if(e(r)){const o=r.path;let a;if(r.snap)le(t,o)?(a=K(t,o),i=ut(i,a,r.snap)):le(o,t)&&(a=K(o,t),i=ut(i,k(),r.snap.getChild(a)));else if(r.children){if(le(t,o))a=K(t,o),i=hs(i,a,r.children);else if(le(o,t))if(a=K(o,t),N(a))i=hs(i,k(),r.children);else{const l=qe(r.children,S(a));if(l){const c=l.getChild(L(a));i=ut(i,k(),c)}}}else throw Xe("WriteRecord should have .snap or .children")}}return i}function xr(n,e,t,i,s){if(!i&&!s){const r=We(n.visibleWrites,e);if(r!=null)return r;{const o=Ie(n.visibleWrites,e);if(Bn(o))return t;if(t==null&&!Fn(o,k()))return null;{const a=t||v.EMPTY_NODE;return Qe(o,a)}}}else{const r=Ie(n.visibleWrites,e);if(!s&&Bn(r))return t;if(!s&&t==null&&!Fn(r,k()))return null;{const o=function(c){return(c.visible||s)&&(!i||!~i.indexOf(c.writeId))&&(le(c.path,e)||le(e,c.path))},a=Mr(n.allWrites,o,e),l=t||v.EMPTY_NODE;return Qe(a,l)}}}function Qc(n,e,t){let i=v.EMPTY_NODE;const s=We(n.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild($,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(t){const r=Ie(n.visibleWrites,e);return t.forEachChild($,(o,a)=>{const l=Qe(Ie(r,new D(o)),a);i=i.updateImmediateChild(o,l)}),ds(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=Ie(n.visibleWrites,e);return ds(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function Xc(n,e,t,i,s){p(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=V(e,t);if(Fn(n.visibleWrites,r))return null;{const o=Ie(n.visibleWrites,r);return Bn(o)?s.getChild(t):Qe(o,s.getChild(t))}}function Jc(n,e,t,i){const s=V(e,t),r=We(n.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(t)){const o=Ie(n.visibleWrites,s);return Qe(o,i.getNode().getImmediateChild(t))}else return null}function Zc(n,e){return We(n.visibleWrites,e)}function eh(n,e,t,i,s,r,o){let a;const l=Ie(n.visibleWrites,e),c=We(l,k());if(c!=null)a=c;else if(t!=null)a=Qe(l,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const f=[],u=o.getCompare(),d=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let m=d.getNext();for(;m&&f.length<s;)u(m,i)!==0&&f.push(m),m=d.getNext();return f}else return[]}function th(){return{visibleWrites:he.empty(),allWrites:[],lastWriteId:-1}}function Yt(n,e,t,i){return xr(n.writeTree,n.treePath,e,t,i)}function ri(n,e){return Qc(n.writeTree,n.treePath,e)}function fs(n,e,t,i){return Xc(n.writeTree,n.treePath,e,t,i)}function Kt(n,e){return Zc(n.writeTree,V(n.treePath,e))}function nh(n,e,t,i,s,r){return eh(n.writeTree,n.treePath,e,t,i,s,r)}function oi(n,e,t){return Jc(n.writeTree,n.treePath,e,t)}function kr(n,e){return Dr(V(n.treePath,e),n.writeTree)}function Dr(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sh{getCompleteChild(e){return null}getChildAfterChild(e,t,i){return null}}const Pr=new sh;class ai{constructor(e,t,i=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=i}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new Ne(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return oi(this.writes_,e,i)}}getChildAfterChild(e,t,i){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Fe(this.viewCache_),r=nh(this.writes_,s,t,1,i,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rh(n){return{filter:n}}function oh(n,e){p(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),p(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function ah(n,e,t,i,s){const r=new ih;let o,a;if(t.type===ce.OVERWRITE){const c=t;c.source.fromUser?o=Wn(n,e,c.path,c.snap,i,s,r):(p(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered()&&!N(c.path),o=Qt(n,e,c.path,c.snap,i,s,a,r))}else if(t.type===ce.MERGE){const c=t;c.source.fromUser?o=ch(n,e,c.path,c.children,i,s,r):(p(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered(),o=Un(n,e,c.path,c.children,i,s,a,r))}else if(t.type===ce.ACK_USER_WRITE){const c=t;c.revert?o=dh(n,e,c.path,i,s,r):o=hh(n,e,c.path,c.affectedTree,i,s,r)}else if(t.type===ce.LISTEN_COMPLETE)o=uh(n,e,t.path,i,r);else throw Xe("Unknown operation type: "+t.type);const l=r.getChanges();return lh(e,o,l),{viewCache:o,changes:l}}function lh(n,e,t){const i=e.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=qt(n);(t.length>0||!n.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&t.push(Sr(qt(e)))}}function Or(n,e,t,i,s,r){const o=e.eventCache;if(Kt(i,t)!=null)return e;{let a,l;if(N(t))if(p(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=Fe(e),f=c instanceof v?c:v.EMPTY_NODE,u=ri(i,f);a=n.filter.updateFullNode(e.eventCache.getNode(),u,r)}else{const c=Yt(i,Fe(e));a=n.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const c=S(t);if(c===".priority"){p(Te(t)===1,"Can't have a priority with additional path components");const f=o.getNode();l=e.serverCache.getNode();const u=fs(i,t,f,l);u!=null?a=n.filter.updatePriority(f,u):a=o.getNode()}else{const f=L(t);let u;if(o.isCompleteForChild(c)){l=e.serverCache.getNode();const d=fs(i,t,o.getNode(),l);d!=null?u=o.getNode().getImmediateChild(c).updateChild(f,d):u=o.getNode().getImmediateChild(c)}else u=oi(i,c,e.serverCache);u!=null?a=n.filter.updateChild(o.getNode(),c,u,f,s,r):a=o.getNode()}}return ht(e,a,o.isFullyInitialized()||N(t),n.filter.filtersNodes())}}function Qt(n,e,t,i,s,r,o,a){const l=e.serverCache;let c;const f=o?n.filter:n.filter.getIndexedFilter();if(N(t))c=f.updateFullNode(l.getNode(),i,null);else if(f.filtersNodes()&&!l.isFiltered()){const m=l.getNode().updateChild(t,i);c=f.updateFullNode(l.getNode(),m,null)}else{const m=S(t);if(!l.isCompleteForPath(t)&&Te(t)>1)return e;const g=L(t),w=l.getNode().getImmediateChild(m).updateChild(g,i);m===".priority"?c=f.updatePriority(l.getNode(),w):c=f.updateChild(l.getNode(),m,w,g,Pr,null)}const u=Rr(e,c,l.isFullyInitialized()||N(t),f.filtersNodes()),d=new ai(s,u,r);return Or(n,u,t,s,d,a)}function Wn(n,e,t,i,s,r,o){const a=e.eventCache;let l,c;const f=new ai(s,e,r);if(N(t))c=n.filter.updateFullNode(e.eventCache.getNode(),i,o),l=ht(e,c,!0,n.filter.filtersNodes());else{const u=S(t);if(u===".priority")c=n.filter.updatePriority(e.eventCache.getNode(),i),l=ht(e,c,a.isFullyInitialized(),a.isFiltered());else{const d=L(t),m=a.getNode().getImmediateChild(u);let g;if(N(d))g=i;else{const x=f.getCompleteChild(u);x!=null?mr(d)===".priority"&&x.getChild(yr(d)).isEmpty()?g=x:g=x.updateChild(d,i):g=v.EMPTY_NODE}if(m.equals(g))l=e;else{const x=n.filter.updateChild(a.getNode(),u,g,d,f,o);l=ht(e,x,a.isFullyInitialized(),n.filter.filtersNodes())}}}return l}function _s(n,e){return n.eventCache.isCompleteForChild(e)}function ch(n,e,t,i,s,r,o){let a=e;return i.foreach((l,c)=>{const f=V(t,l);_s(e,S(f))&&(a=Wn(n,a,f,c,s,r,o))}),i.foreach((l,c)=>{const f=V(t,l);_s(e,S(f))||(a=Wn(n,a,f,c,s,r,o))}),a}function ps(n,e,t){return t.foreach((i,s)=>{e=e.updateChild(i,s)}),e}function Un(n,e,t,i,s,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,c;N(t)?c=i:c=new B(null).setTree(t,i);const f=e.serverCache.getNode();return c.children.inorderTraversal((u,d)=>{if(f.hasChild(u)){const m=e.serverCache.getNode().getImmediateChild(u),g=ps(n,m,d);l=Qt(n,l,new D(u),g,s,r,o,a)}}),c.children.inorderTraversal((u,d)=>{const m=!e.serverCache.isCompleteForChild(u)&&d.value===null;if(!f.hasChild(u)&&!m){const g=e.serverCache.getNode().getImmediateChild(u),x=ps(n,g,d);l=Qt(n,l,new D(u),x,s,r,o,a)}}),l}function hh(n,e,t,i,s,r,o){if(Kt(s,t)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(i.value!=null){if(N(t)&&l.isFullyInitialized()||l.isCompleteForPath(t))return Qt(n,e,t,l.getNode().getChild(t),s,r,a,o);if(N(t)){let c=new B(null);return l.getNode().forEachChild(ze,(f,u)=>{c=c.set(new D(f),u)}),Un(n,e,t,c,s,r,a,o)}else return e}else{let c=new B(null);return i.foreach((f,u)=>{const d=V(t,f);l.isCompleteForPath(d)&&(c=c.set(f,l.getNode().getChild(d)))}),Un(n,e,t,c,s,r,a,o)}}function uh(n,e,t,i,s){const r=e.serverCache,o=Rr(e,r.getNode(),r.isFullyInitialized()||N(t),r.isFiltered());return Or(n,o,t,i,Pr,s)}function dh(n,e,t,i,s,r){let o;if(Kt(i,t)!=null)return e;{const a=new ai(i,e,s),l=e.eventCache.getNode();let c;if(N(t)||S(t)===".priority"){let f;if(e.serverCache.isFullyInitialized())f=Yt(i,Fe(e));else{const u=e.serverCache.getNode();p(u instanceof v,"serverChildren would be complete if leaf node"),f=ri(i,u)}f=f,c=n.filter.updateFullNode(l,f,r)}else{const f=S(t);let u=oi(i,f,e.serverCache);u==null&&e.serverCache.isCompleteForChild(f)&&(u=l.getImmediateChild(f)),u!=null?c=n.filter.updateChild(l,f,u,L(t),a,r):e.eventCache.getNode().hasChild(f)?c=n.filter.updateChild(l,f,v.EMPTY_NODE,L(t),a,r):c=l,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=Yt(i,Fe(e)),o.isLeafNode()&&(c=n.filter.updateFullNode(c,o,r)))}return o=e.serverCache.isFullyInitialized()||Kt(i,k())!=null,ht(e,c,o,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Jt;function Ih(n){p(!Jt,"__referenceConstructor has already been defined"),Jt=n}function Sh(){return p(Jt,"Reference.ts has not been loaded"),Jt}let Th=1;class vs{constructor(e){this.listenProvider_=e,this.syncPointTree_=new B(null),this.pendingWriteTree_=th(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Hr(n,e,t,i,s){return Gc(n.pendingWriteTree_,e,t,i,s),s?At(n,new Le(Nr(),e,t)):[]}function De(n,e,t=!1){const i=zc(n.pendingWriteTree_,e);if(jc(n.pendingWriteTree_,e)){let r=new B(null);return i.snap!=null?r=r.set(k(),!0):te(i.children,o=>{r=r.set(new D(o),!0)}),At(n,new jt(i.path,r,t))}else return[]}function Rt(n,e,t){return At(n,new Le(ii(),e,t))}function Nh(n,e,t){const i=B.fromObject(t);return At(n,new Et(ii(),e,i))}function Rh(n,e){return At(n,new Ct(ii(),e))}function Ah(n,e,t){const i=hi(n,t);if(i){const s=ui(i),r=s.path,o=s.queryId,a=K(r,e),l=new Ct(si(o),a);return di(n,r,l)}else return[]}function Zt(n,e,t,i,s=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||$r(o,e))){const l=bh(o,e,t,i);Eh(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!s){const f=c.findIndex(d=>d._queryParams.loadsAllData())!==-1,u=n.syncPointTree_.findOnPath(r,(d,m)=>Re(m));if(f&&!u){const d=n.syncPointTree_.subtree(r);if(!d.isEmpty()){const m=kh(d);for(let g=0;g<m.length;++g){const x=m[g],w=x.query,ne=jr(n,x);n.listenProvider_.startListening(dt(w),wt(n,w),ne.hashFn,ne.onComplete)}}}!u&&c.length>0&&!i&&(f?n.listenProvider_.stopListening(dt(e),null):c.forEach(d=>{const m=n.queryToTagMap.get(ln(d));n.listenProvider_.stopListening(dt(d),m)}))}Dh(n,c)}return a}function Vr(n,e,t,i){const s=hi(n,i);if(s!=null){const r=ui(s),o=r.path,a=r.queryId,l=K(o,e),c=new Le(si(a),l,t);return di(n,o,c)}else return[]}function Mh(n,e,t,i){const s=hi(n,i);if(s){const r=ui(s),o=r.path,a=r.queryId,l=K(o,e),c=B.fromObject(t),f=new Et(si(a),l,c);return di(n,o,f)}else return[]}function $n(n,e,t,i=!1){const s=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(s,(d,m)=>{const g=K(d,s);r=r||Se(m,g),o=o||Re(m)});let a=n.syncPointTree_.get(s);a?(o=o||Re(a),r=r||Se(a,k())):(a=new Fr,n.syncPointTree_=n.syncPointTree_.set(s,a));let l;r!=null?l=!0:(l=!1,r=v.EMPTY_NODE,n.syncPointTree_.subtree(s).foreachChild((m,g)=>{const x=Se(g,k());x&&(r=r.updateImmediateChild(m,x))}));const c=$r(a,e);if(!c&&!e._queryParams.loadsAllData()){const d=ln(e);p(!n.queryToTagMap.has(d),"View does not exist, but we have a tag");const m=Ph();n.queryToTagMap.set(d,m),n.tagToQueryMap.set(m,d)}const f=on(n.pendingWriteTree_,s);let u=wh(a,e,t,f,r,l);if(!c&&!o&&!i){const d=Ur(a,e);u=u.concat(Oh(n,e,d))}return u}function ci(n,e,t){const s=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const l=K(o,e),c=Se(a,l);if(c)return c});return xr(s,e,r,t,!0)}function xh(n,e){const t=e._path;let i=null;n.syncPointTree_.foreachOnPath(t,(c,f)=>{const u=K(c,t);i=i||Se(f,u)});let s=n.syncPointTree_.get(t);s?i=i||Se(s,k()):(s=new Fr,n.syncPointTree_=n.syncPointTree_.set(t,s));const r=i!=null,o=r?new Ne(i,!0,!1):null,a=on(n.pendingWriteTree_,e._path),l=Br(s,e,a,r?o.getNode():v.EMPTY_NODE,r);return ph(l)}function At(n,e){return Gr(e,n.syncPointTree_,null,on(n.pendingWriteTree_,k()))}function Gr(n,e,t,i){if(N(n.path))return zr(n,e,t,i);{const s=e.get(k());t==null&&s!=null&&(t=Se(s,k()));let r=[];const o=S(n.path),a=n.operationForChild(o),l=e.children.get(o);if(l&&a){const c=t?t.getImmediateChild(o):null,f=kr(i,o);r=r.concat(Gr(a,l,c,f))}return s&&(r=r.concat(li(s,n,i,t))),r}}function zr(n,e,t,i){const s=e.get(k());t==null&&s!=null&&(t=Se(s,k()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=t?t.getImmediateChild(o):null,c=kr(i,o),f=n.operationForChild(o);f&&(r=r.concat(zr(f,a,l,c)))}),s&&(r=r.concat(li(s,n,i,t))),r}function jr(n,e){const t=e.query,i=wt(n,t);return{hashFn:()=>(_h(e)||v.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?Ah(n,t._path,i):Rh(n,t._path);{const r=xl(s,t);return Zt(n,t,null,r)}}}}function wt(n,e){const t=ln(e);return n.queryToTagMap.get(t)}function ln(n){return n._path.toString()+"$"+n._queryIdentifier}function hi(n,e){return n.tagToQueryMap.get(e)}function ui(n){const e=n.indexOf("$");return p(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new D(n.substr(0,e))}}function di(n,e,t){const i=n.syncPointTree_.get(e);p(i,"Missing sync point for query tag that we're tracking");const s=on(n.pendingWriteTree_,e);return li(i,t,s,null)}function kh(n){return n.fold((e,t,i)=>{if(t&&Re(t))return[an(t)];{let s=[];return t&&(s=Wr(t)),te(i,(r,o)=>{s=s.concat(o)}),s}})}function dt(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(Sh())(n._repo,n._path):n}function Dh(n,e){for(let t=0;t<e.length;++t){const i=e[t];if(!i._queryParams.loadsAllData()){const s=ln(i),r=n.queryToTagMap.get(s);n.queryToTagMap.delete(s),n.tagToQueryMap.delete(r)}}}function Ph(){return Th++}function Oh(n,e,t){const i=e._path,s=wt(n,e),r=jr(n,t),o=n.listenProvider_.startListening(dt(e),s,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(i);if(s)p(!Re(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,f,u)=>{if(!N(c)&&f&&Re(f))return[an(f).query];{let d=[];return f&&(d=d.concat(Wr(f).map(m=>m.query))),te(u,(m,g)=>{d=d.concat(g)}),d}});for(let c=0;c<l.length;++c){const f=l[c];n.listenProvider_.stopListening(dt(f),wt(n,f))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qh{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function vi(n,e){let t=null;for(let i=0;i<e.length;i++){const s=e[i],r=s.getPath();t!==null&&!Jn(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(s)}t&&n.eventLists_.push(t)}function eo(n,e,t){vi(n,t),to(n,i=>Jn(i,e))}function de(n,e,t){vi(n,t),to(n,i=>le(i,e)||le(e,i))}function to(n,e){n.recursionDepth_++;let t=!0;for(let i=0;i<n.eventLists_.length;i++){const s=n.eventLists_[i];if(s){const r=s.path;e(r)?(Xh(n.eventLists_[i]),n.eventLists_[i]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function Xh(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const i=t.getEventRunner();lt&&Y("event: "+t.toString()),et(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jh="repo_interrupt",Zh=25;class eu{constructor(e,t,i,s){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=i,this.appCheckProvider_=s,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Qh,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=zt(),this.transactionQueueTree_=new mi,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function tu(n,e,t){if(n.stats_=Qn(n.repoInfo_),n.forceRestClient_||Ol())n.server_=new Gt(n.repoInfo_,(i,s,r,o)=>{Es(n,i,s,r,o)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>ws(n,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{H(t)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}n.persistentConnection_=new pe(n.repoInfo_,e,(i,s,r,o)=>{Es(n,i,s,r,o)},i=>{ws(n,i)},i=>{iu(n,i)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(i=>{n.server_.refreshAuthToken(i)}),n.appCheckProvider_.addTokenChangeListener(i=>{n.server_.refreshAppCheckToken(i.token)}),n.statsReporter_=Ul(n.repoInfo_,()=>new Bc(n.stats_,n.server_)),n.infoData_=new Dc,n.infoSyncTree_=new vs({startListening:(i,s,r,o)=>{let a=[];const l=n.infoData_.getNode(i._path);return l.isEmpty()||(a=Rt(n.infoSyncTree_,i._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),Ei(n,"connected",!1),n.serverSyncTree_=new vs({startListening:(i,s,r,o)=>(n.server_.listen(i,r,s,(a,l)=>{const c=o(a,l);de(n.eventQueue_,i._path,c)}),[]),stopListening:(i,s)=>{n.server_.unlisten(i,s)}})}function nu(n){const t=n.infoData_.getNode(new D(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function Ci(n){return Lh({timestamp:nu(n)})}function Es(n,e,t,i,s){n.dataUpdateCount++;const r=new D(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let o=[];if(s)if(i){const l=Ft(t,c=>j(c));o=Mh(n.serverSyncTree_,r,l,s)}else{const l=j(t);o=Vr(n.serverSyncTree_,r,l,s)}else if(i){const l=Ft(t,c=>j(c));o=Nh(n.serverSyncTree_,r,l)}else{const l=j(t);o=Rt(n.serverSyncTree_,r,l)}let a=r;o.length>0&&(a=un(n,r)),de(n.eventQueue_,a,o)}function ws(n,e){Ei(n,"connected",e),e===!1&&ou(n)}function iu(n,e){te(e,(t,i)=>{Ei(n,t,i)})}function Ei(n,e,t){const i=new D("/.info/"+e),s=j(t);n.infoData_.updateSnapshot(i,s);const r=Rt(n.infoSyncTree_,i,s);de(n.eventQueue_,i,r)}function no(n){return n.nextWriteId_++}function su(n,e,t){const i=xh(n.serverSyncTree_,e);return i!=null?Promise.resolve(i):n.server_.get(e).then(s=>{const r=j(s).withIndex(e._queryParams.getIndex());$n(n.serverSyncTree_,e,t,!0);let o;if(e._queryParams.loadsAllData())o=Rt(n.serverSyncTree_,e._path,r);else{const a=wt(n.serverSyncTree_,e);o=Vr(n.serverSyncTree_,e._path,r,a)}return de(n.eventQueue_,e._path,o),Zt(n.serverSyncTree_,e,t,null,!0),r},s=>(hn(n,"get for query "+H(e)+" failed: "+s),Promise.reject(new Error(s))))}function ru(n,e,t,i,s){hn(n,"set",{path:e.toString(),value:t,priority:i});const r=Ci(n),o=j(t,i),a=ci(n.serverSyncTree_,e),l=qr(o,a,r),c=no(n),f=Hr(n.serverSyncTree_,e,l,c,!0);vi(n.eventQueue_,f),n.server_.put(e.toString(),o.val(!0),(d,m)=>{const g=d==="ok";g||ee("set at "+e+" failed: "+d);const x=De(n.serverSyncTree_,c,!g);de(n.eventQueue_,e,x),cu(n,s,d,m)});const u=ao(n,e);un(n,u),de(n.eventQueue_,u,[])}function ou(n){hn(n,"onDisconnectEvents");const e=Ci(n),t=zt();Ln(n.onDisconnect_,k(),(s,r)=>{const o=Wh(s,r,n.serverSyncTree_,e);Tr(t,s,o)});let i=[];Ln(t,k(),(s,r)=>{i=i.concat(Rt(n.serverSyncTree_,s,r));const o=ao(n,s);un(n,o)}),n.onDisconnect_=zt(),de(n.eventQueue_,k(),i)}function au(n,e,t){let i;S(e._path)===".info"?i=$n(n.infoSyncTree_,e,t):i=$n(n.serverSyncTree_,e,t),eo(n.eventQueue_,e._path,i)}function bs(n,e,t){let i;S(e._path)===".info"?i=Zt(n.infoSyncTree_,e,t):i=Zt(n.serverSyncTree_,e,t),eo(n.eventQueue_,e._path,i)}function lu(n){n.persistentConnection_&&n.persistentConnection_.interrupt(Jh)}function hn(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),Y(t,...e)}function cu(n,e,t,i){e&&et(()=>{if(t==="ok")e(null);else{const s=(t||"error").toUpperCase();let r=s;i&&(r+=": "+i);const o=new Error(r);o.code=s,e(o)}})}function io(n,e,t){return ci(n.serverSyncTree_,e,t)||v.EMPTY_NODE}function wi(n,e=n.transactionQueueTree_){if(e||dn(n,e),tt(e)){const t=ro(n,e);p(t.length>0,"Sending zero length transaction queue"),t.every(s=>s.status===0)&&hu(n,Mt(e),t)}else Kr(e)&&cn(e,t=>{wi(n,t)})}function hu(n,e,t){const i=t.map(c=>c.currentWriteId),s=io(n,e,i);let r=s;const o=s.hash();for(let c=0;c<t.length;c++){const f=t[c];p(f.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),f.status=1,f.retryCount++;const u=K(e,f.path);r=r.updateChild(u,f.currentOutputSnapshotRaw)}const a=r.val(!0),l=e;n.server_.put(l.toString(),a,c=>{hn(n,"transaction put response",{path:l.toString(),status:c});let f=[];if(c==="ok"){const u=[];for(let d=0;d<t.length;d++)t[d].status=2,f=f.concat(De(n.serverSyncTree_,t[d].currentWriteId)),t[d].onComplete&&u.push(()=>t[d].onComplete(null,!0,t[d].currentOutputSnapshotResolved)),t[d].unwatcher();dn(n,gi(n.transactionQueueTree_,e)),wi(n,n.transactionQueueTree_),de(n.eventQueue_,e,f);for(let d=0;d<u.length;d++)et(u[d])}else{if(c==="datastale")for(let u=0;u<t.length;u++)t[u].status===3?t[u].status=4:t[u].status=0;else{ee("transaction at "+l.toString()+" failed: "+c);for(let u=0;u<t.length;u++)t[u].status=4,t[u].abortReason=c}un(n,e)}},o)}function un(n,e){const t=so(n,e),i=Mt(t),s=ro(n,t);return uu(n,s,i),i}function uu(n,e,t){if(e.length===0)return;const i=[];let s=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=K(t,l.path);let f=!1,u;if(p(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)f=!0,u=l.abortReason,s=s.concat(De(n.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=Zh)f=!0,u="maxretry",s=s.concat(De(n.serverSyncTree_,l.currentWriteId,!0));else{const d=io(n,l.path,o);l.currentInputSnapshot=d;const m=e[a].update(d.val());if(m!==void 0){yi("transaction failed: Data returned ",m,l.path);let g=j(m);typeof m=="object"&&m!=null&&ve(m,".priority")||(g=g.updatePriority(d.getPriority()));const w=l.currentWriteId,ne=Ci(n),ie=qr(g,d,ne);l.currentOutputSnapshotRaw=g,l.currentOutputSnapshotResolved=ie,l.currentWriteId=no(n),o.splice(o.indexOf(w),1),s=s.concat(Hr(n.serverSyncTree_,l.path,ie,l.currentWriteId,l.applyLocally)),s=s.concat(De(n.serverSyncTree_,w,!0))}else f=!0,u="nodata",s=s.concat(De(n.serverSyncTree_,l.currentWriteId,!0))}de(n.eventQueue_,t,s),s=[],f&&(e[a].status=2,function(d){setTimeout(d,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(u==="nodata"?i.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):i.push(()=>e[a].onComplete(new Error(u),!1,null))))}dn(n,n.transactionQueueTree_);for(let a=0;a<i.length;a++)et(i[a]);wi(n,n.transactionQueueTree_)}function so(n,e){let t,i=n.transactionQueueTree_;for(t=S(e);t!==null&&tt(i)===void 0;)i=gi(i,t),e=L(e),t=S(e);return i}function ro(n,e){const t=[];return oo(n,e,t),t.sort((i,s)=>i.order-s.order),t}function oo(n,e,t){const i=tt(e);if(i)for(let s=0;s<i.length;s++)t.push(i[s]);cn(e,s=>{oo(n,s,t)})}function dn(n,e){const t=tt(e);if(t){let i=0;for(let s=0;s<t.length;s++)t[s].status!==2&&(t[i]=t[s],i++);t.length=i,Yr(e,t.length>0?t:void 0)}cn(e,i=>{dn(n,i)})}function ao(n,e){const t=Mt(so(n,e)),i=gi(n.transactionQueueTree_,e);return $h(i,s=>{Tn(n,s)}),Tn(n,i),Qr(i,s=>{Tn(n,s)}),t}function Tn(n,e){const t=tt(e);if(t){const i=[];let s=[],r=-1;for(let o=0;o<t.length;o++)t[o].status===3||(t[o].status===1?(p(r===o-1,"All SENT items should be at beginning of queue."),r=o,t[o].status=3,t[o].abortReason="set"):(p(t[o].status===0,"Unexpected transaction status in abort"),t[o].unwatcher(),s=s.concat(De(n.serverSyncTree_,t[o].currentWriteId,!0)),t[o].onComplete&&i.push(t[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?Yr(e,void 0):t.length=r+1,de(n.eventQueue_,Mt(e),s);for(let o=0;o<i.length;o++)et(i[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function du(n){let e="";const t=n.split("/");for(let i=0;i<t.length;i++)if(t[i].length>0){let s=t[i];try{s=decodeURIComponent(s.replace(/\+/g," "))}catch{}e+="/"+s}return e}function fu(n){const e={};n.charAt(0)==="?"&&(n=n.substring(1));for(const t of n.split("&")){if(t.length===0)continue;const i=t.split("=");i.length===2?e[decodeURIComponent(i[0])]=decodeURIComponent(i[1]):ee(`Invalid query segment '${t}' in query '${n}'`)}return e}const Is=function(n,e){const t=_u(n),i=t.namespace;t.domain==="firebase.com"&&ye(t.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!i||i==="undefined")&&t.domain!=="localhost"&&ye("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),t.secure||Tl();const s=t.scheme==="ws"||t.scheme==="wss";return{repoInfo:new ar(t.host,t.secure,i,s,e,"",i!==t.subdomain),path:new D(t.pathString)}},_u=function(n){let e="",t="",i="",s="",r="",o=!0,a="https",l=443;if(typeof n=="string"){let c=n.indexOf("//");c>=0&&(a=n.substring(0,c-1),n=n.substring(c+2));let f=n.indexOf("/");f===-1&&(f=n.length);let u=n.indexOf("?");u===-1&&(u=n.length),e=n.substring(0,Math.min(f,u)),f<u&&(s=du(n.substring(f,u)));const d=fu(n.substring(Math.min(n.length,u)));c=e.indexOf(":"),c>=0?(o=a==="https"||a==="wss",l=parseInt(e.substring(c+1),10)):c=e.length;const m=e.slice(0,c);if(m.toLowerCase()==="localhost")t="localhost";else if(m.split(".").length<=2)t=m;else{const g=e.indexOf(".");i=e.substring(0,g).toLowerCase(),t=e.substring(g+1),r=i}"ns"in d&&(r=d.ns)}return{host:e,port:l,domain:t,subdomain:i,secure:o,scheme:a,pathString:s,namespace:r}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bi{constructor(e,t,i,s){this._repo=e,this._path=t,this._queryParams=i,this._orderByCalled=s}get key(){return N(this._path)?null:mr(this._path)}get ref(){return new Ce(this._repo,this._path)}get _queryIdentifier(){const e=ls(this._queryParams),t=Yn(e);return t==="{}"?"default":t}get _queryObject(){return ls(this._queryParams)}isEqual(e){if(e=Je(e),!(e instanceof bi))return!1;const t=this._repo===e._repo,i=Jn(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return t&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+cc(this._path)}}class Ce extends bi{constructor(e,t){super(e,t,new ni,!1)}get parent(){const e=yr(this._path);return e===null?null:new Ce(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class bt{constructor(e,t,i){this._node=e,this.ref=t,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new D(e),i=en(this.ref,e);return new bt(this._node.getChild(t),i,$)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new bt(s,en(this.ref,i),$)))}hasChild(e){const t=new D(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function J(n,e){return n=Je(n),n._checkNotDeleted("ref"),e!==void 0?en(n._root,e):n._root}function en(n,e){return n=Je(n),S(n._path)===null?qh("child","path",e):Zr("child","path",e),new Ce(n._repo,V(n._path,e))}function Pe(n,e){n=Je(n),Yh("set",n._path),jh("set",e,n._path);const t=new tn;return ru(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function co(n){n=Je(n);const e=new lo(()=>{}),t=new fn(e);return su(n._repo,n,t).then(i=>new bt(i,new Ce(n._repo,n._path),n._queryParams.getIndex()))}class fn{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const i=t._queryParams.getIndex();return new pu("value",this,new bt(e.snapshotNode,new Ce(t._repo,t._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new mu(this,e,t):null}matches(e){return e instanceof fn?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function gu(n,e,t,i,s){let r;if(typeof i=="object"&&(r=void 0,s=i),typeof i=="function"&&(r=i),s&&s.onlyOnce){const l=t,c=(f,u)=>{bs(n._repo,n,a),l(f,u)};c.userCallback=t.userCallback,c.context=t.context,t=c}const o=new lo(t,r||void 0),a=new fn(o);return au(n._repo,n,a),()=>bs(n._repo,n,a)}function xt(n,e,t,i){return gu(n,"value",e,t,i)}vh(Ce);Ih(Ce);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yu="FIREBASE_DATABASE_EMULATOR_HOST",Vn={};let vu=!1;function Cu(n,e,t,i){const s=e.lastIndexOf(":"),r=e.substring(0,s),o=zn(r);n.repoInfo_=new ar(e,o,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0,t),i&&(n.authTokenProvider_=i)}function Eu(n,e,t,i,s){let r=i||n.options.databaseURL;r===void 0&&(n.options.projectId||ye("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Y("Using default host for project ",n.options.projectId),r=`${n.options.projectId}-default-rtdb.firebaseio.com`);let o=Is(r,s),a=o.repoInfo,l;typeof process<"u"&&Gi&&(l=Gi[yu]),l?(r=`http://${l}?ns=${a.namespace}`,o=Is(r,s),a=o.repoInfo):o.repoInfo.secure;const c=new Fl(n.name,n.options,e);Kh("Invalid Firebase Database URL",o),N(o.path)||ye("Database URL must point to the root of a Firebase Database (not including a child path).");const f=bu(a,n,c,new Ll(n,t));return new Iu(f,n)}function wu(n,e){const t=Vn[e];(!t||t[n.key]!==n)&&ye(`Database ${e}(${n.repoInfo_}) has already been deleted.`),lu(n),delete t[n.key]}function bu(n,e,t,i){let s=Vn[e.name];s||(s={},Vn[e.name]=s);let r=s[n.toURLString()];return r&&ye("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new eu(n,vu,t,i),s[n.toURLString()]=r,r}class Iu{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(tu(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Ce(this._repo,k())),this._rootInternal}_delete(){return this._rootInternal!==null&&(wu(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&ye("Cannot call "+e+" on a deleted database.")}}function Su(n=al(),e){const t=nl(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const i=$o("database");i&&Tu(t,...i)}return t}function Tu(n,e,t,i={}){n=Je(n),n._checkNotDeleted("useEmulator");const s=`${e}:${t}`,r=n._repoInternal;if(n._instanceStarted){if(s===n._repoInternal.repoInfo_.host&&Bt(i,r.repoInfo_.emulatorOptions))return;ye("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let o;if(r.repoInfo_.nodeAdmin)i.mockUserToken&&ye('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new Ot(Ot.OWNER);else if(i.mockUserToken){const a=typeof i.mockUserToken=="string"?i.mockUserToken:Vo(i.mockUserToken,n.app.options.projectId);o=new Ot(a)}zn(e)&&(Ho(e),jo("Database",!0)),Cu(r,s,i,o)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
2. Divide by ${l}: x = ${s}`}}Pe(J(Z,"activeSteps"),r),Pe(J(Z,"activeProblem"),i),Pe(J(Z,"correctAnswer"),s),Pe(J(Z,"currentWork"),""),Be&&(Be.value="")}Ns&&Ns.addEventListener("click",()=>{const n=Be.value.trim(),e=Number(n);xt(J(Z,"correctAnswer"),t=>{const i=Number(t.val());e===i&&n!==""?(Ee+=1,He&&(He.innerText=Ee),co(en(J(Z),"worldRecord")).then(s=>{const r=s.val()||0;Ee>r&&(Pe(J(Z,"worldRecord"),Ee),console.log("🏆 NEW WORLD RECORD!"))}),Ru({particleCount:150,spread:70,origin:{y:.6},colors:["#22d3ee","#f8fafc","#334155"]}),Pt.classList.add("success-glow"),me.style.color="var(--accent-cyan)",Ee>=3&&(Pt.style.boxShadow="0 0 50px var(--accent-cyan)"),setTimeout(()=>{alert(`CORRECT! 🚀 STREAK: ${Ee}`),Pt.classList.remove("success-glow"),Be.value="",Si(je)},500)):(Ee=0,He&&(He.innerText="0"),Pt.style.boxShadow="none",me.style.color="var(--danger-red)",alert("TRY AGAIN... ❌ STREAK RESET"))},{onlyOnce:!0})});Rs?(console.log("Found the hint button!"),Rs.addEventListener("click",n=>{n.stopPropagation(),console.log("CLICKED!"),co(J(Z,"activeSteps")).then(e=>{const t=e.val();console.log("Firebase Data Received:",t),t?(me.innerText=`--- HOW TO SOLVE ---
`+t,me.style.color="#fbbf24",Ee=0,He&&(He.innerText="0")):me.innerText="No work found in database."}).catch(e=>{console.error("Firebase Error:",e.message)})})):console.error("COULD NOT FIND hint-btn IN HTML");
