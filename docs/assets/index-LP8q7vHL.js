 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ko(n){return ks(void 0,n)}function ks(n,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const t=e;return new Date(t.getTime());case Object:n===void 0&&(n={});break;case Array:n=[];break;default:return e}for(const t in e)!e.hasOwnProperty(t)||!Po(t)||(n[t]=ks(n[t],e[t]));return n}function Po(n){return n!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const me=new Bs("@firebase/app"),Sa="@firebase/app-compat",Ta="@firebase/analytics-compat",Na="@firebase/analytics",Ra="@firebase/app-check-compat",Aa="@firebase/app-check",Ma="@firebase/auth",xa="@firebase/auth-compat",ka="@firebase/database",Pa="@firebase/data-connect",Da="@firebase/database-compat",Oa="@firebase/functions",La="@firebase/functions-compat",Fa="@firebase/installations",Ba="@firebase/installations-compat",Wa="@firebase/messaging",Ua="@firebase/messaging-compat",Ha="@firebase/performance",Va="@firebase/performance-compat",$a="@firebase/remote-config",Ga="@firebase/remote-config-compat",za="@firebase/storage",ja="@firebase/storage-compat",qa="@firebase/firestore",Ya="@firebase/ai",Ka="@firebase/firestore-compat",Qa="firebase",Xa="11.10.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mn="[DEFAULT]",Ja={[An]:"fire-core",[Sa]:"fire-core-compat",[Na]:"fire-analytics",[Ta]:"fire-analytics-compat",[Aa]:"fire-app-check",[Ra]:"fire-app-check-compat",[Ma]:"fire-auth",[xa]:"fire-auth-compat",[ka]:"fire-rtdb",[Pa]:"fire-data-connect",[Da]:"fire-rtdb-compat",[Oa]:"fire-fn",[La]:"fire-fn-compat",[Fa]:"fire-iid",[Ba]:"fire-iid-compat",[Wa]:"fire-fcm",[Ua]:"fire-fcm-compat",[Ha]:"fire-perf",[Va]:"fire-perf-compat",[$a]:"fire-rc",[Ga]:"fire-rc-compat",[za]:"fire-gcs",[ja]:"fire-gcs-compat",[qa]:"fire-fst",[Ka]:"fire-fst-compat",[Ya]:"fire-vertex","fire-js":"fire-js",[Qa]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fl{constructor(){this.counters_={}}incrementCounter(e,t=1){ye(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return ko(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gt{constructor(e,t){this.source=e,this.path=t,this.type=ce.LISTEN_COMPLETE}operationForChild(e){return N(this.path)?new gt(this.source,k()):new gt(this.source,L(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class De{constructor(e,t,i){this.source=e,this.path=t,this.snap=i,this.type=ce.OVERWRITE}operationForChild(e){return N(this.path)?new De(this.source,k(),this.snap.getImmediateChild(e)):new De(this.source,L(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yt{constructor(e,t,i){this.source=e,this.path=t,this.children=i,this.type=ce.MERGE}operationForChild(e){if(N(this.path)){const t=this.children.subtree(new P(e));return t.isEmpty()?null:t.value?new De(this.source,k(),t.value):new yt(this.source,k(),t)}else return p(S(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new yt(this.source,L(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Qt;function wh(n){p(!Qt,"__referenceConstructor has already been defined"),Qt=n}function bh(){return p(Qt,"Reference.ts has not been loaded"),Qt}let Ih=1;class ys{constructor(e){this.listenProvider_=e,this.syncPointTree_=new B(null),this.pendingWriteTree_=Zc(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Ur(n,e,t,i,s){return Vc(n.pendingWriteTree_,e,t,i,s),s?Tt(n,new De(Sr(),e,t)):[]}function ke(n,e,t=!1){const i=$c(n.pendingWriteTree_,e);if(Gc(n.pendingWriteTree_,e)){let r=new B(null);return i.snap!=null?r=r.set(k(),!0):Z(i.children,o=>{r=r.set(new P(o),!0)}),Tt(n,new Gt(i.path,r,t))}else return[]}function St(n,e,t){return Tt(n,new De(ii(),e,t))}function Sh(n,e,t){const i=B.fromObject(t);return Tt(n,new yt(ii(),e,i))}function Th(n,e){return Tt(n,new gt(ii(),e))}function Nh(n,e,t){const i=hi(n,t);if(i){const s=ui(i),r=s.path,o=s.queryId,a=K(r,e),l=new gt(si(o),a);return di(n,r,l)}else return[]}function Xt(n,e,t,i,s=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||Wr(o,e))){const l=Eh(o,e,t,i);vh(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!s){const f=c.findIndex(u=>u._queryParams.loadsAllData())!==-1,d=n.syncPointTree_.findOnPath(r,(u,m)=>Te(m));if(f&&!d){const u=n.syncPointTree_.subtree(r);if(!u.isEmpty()){const m=Mh(u);for(let g=0;g<m.length;++g){const x=m[g],w=x.query,ne=Gr(n,x);n.listenProvider_.startListening(ct(w),vt(n,w),ne.hashFn,ne.onComplete)}}}!d&&c.length>0&&!i&&(f?n.listenProvider_.stopListening(ct(e),null):c.forEach(u=>{const m=n.queryToTagMap.get(an(u));n.listenProvider_.stopListening(ct(u),m)}))}xh(n,c)}return a}function Hr(n,e,t,i){const s=hi(n,i);if(s!=null){const r=ui(s),o=r.path,a=r.queryId,l=K(o,e),c=new De(si(a),l,t);return di(n,o,c)}else return[]}function Rh(n,e,t,i){const s=hi(n,i);if(s){const r=ui(s),o=r.path,a=r.queryId,l=K(o,e),c=B.fromObject(t),f=new yt(si(a),l,c);return di(n,o,f)}else return[]}function Un(n,e,t,i=!1){const s=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(s,(u,m)=>{const g=K(u,s);r=r||be(m,g),o=o||Te(m)});let a=n.syncPointTree_.get(s);a?(o=o||Te(a),r=r||be(a,k())):(a=new Or,n.syncPointTree_=n.syncPointTree_.set(s,a));let l;r!=null?l=!0:(l=!1,r=v.EMPTY_NODE,n.syncPointTree_.subtree(s).foreachChild((m,g)=>{const x=be(g,k());x&&(r=r.updateImmediateChild(m,x))}));const c=Wr(a,e);if(!c&&!e._queryParams.loadsAllData()){const u=an(e);p(!n.queryToTagMap.has(u),"View does not exist, but we have a tag");const m=kh();n.queryToTagMap.set(u,m),n.tagToQueryMap.set(m,u)}const f=rn(n.pendingWriteTree_,s);let d=Ch(a,e,t,f,r,l);if(!c&&!o&&!i){const u=Br(a,e);d=d.concat(Ph(n,e,u))}return d}function ci(n,e,t){const s=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const l=K(o,e),c=be(a,l);if(c)return c});return Ar(s,e,r,t,!0)}function Ah(n,e){const t=e._path;let i=null;n.syncPointTree_.foreachOnPath(t,(c,f)=>{const d=K(c,t);i=i||be(f,d)});let s=n.syncPointTree_.get(t);s?i=i||be(s,k()):(s=new Or,n.syncPointTree_=n.syncPointTree_.set(t,s));const r=i!=null,o=r?new Se(i,!0,!1):null,a=rn(n.pendingWriteTree_,e._path),l=Lr(s,e,a,r?o.getNode():v.EMPTY_NODE,r);return fh(l)}function Tt(n,e){return Vr(e,n.syncPointTree_,null,rn(n.pendingWriteTree_,k()))}function Vr(n,e,t,i){if(N(n.path))return $r(n,e,t,i);{const s=e.get(k());t==null&&s!=null&&(t=be(s,k()));let r=[];const o=S(n.path),a=n.operationForChild(o),l=e.children.get(o);if(l&&a){const c=t?t.getImmediateChild(o):null,f=Mr(i,o);r=r.concat(Vr(a,l,c,f))}return s&&(r=r.concat(li(s,n,i,t))),r}}function $r(n,e,t,i){const s=e.get(k());t==null&&s!=null&&(t=be(s,k()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=t?t.getImmediateChild(o):null,c=Mr(i,o),f=n.operationForChild(o);f&&(r=r.concat($r(f,a,l,c)))}),s&&(r=r.concat(li(s,n,i,t))),r}function Gr(n,e){const t=e.query,i=vt(n,t);return{hashFn:()=>(dh(e)||v.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?Nh(n,t._path,i):Th(n,t._path);{const r=Al(s,t);return Xt(n,t,null,r)}}}}function vt(n,e){const t=an(e);return n.queryToTagMap.get(t)}function an(n){return n._path.toString()+"$"+n._queryIdentifier}function hi(n,e){return n.tagToQueryMap.get(e)}function ui(n){const e=n.indexOf("$");return p(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new P(n.substr(0,e))}}function di(n,e,t){const i=n.syncPointTree_.get(e);p(i,"Missing sync point for query tag that we're tracking");const s=rn(n.pendingWriteTree_,e);return li(i,t,s,null)}function Mh(n){return n.fold((e,t,i)=>{if(t&&Te(t))return[on(t)];{let s=[];return t&&(s=Fr(t)),Z(i,(r,o)=>{s=s.concat(o)}),s}})}function ct(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(bh())(n._repo,n._path):n}function xh(n,e){for(let t=0;t<e.length;++t){const i=e[t];if(!i._queryParams.loadsAllData()){const s=an(i),r=n.queryToTagMap.get(s);n.queryToTagMap.delete(s),n.tagToQueryMap.delete(r)}}}function kh(){return Ih++}function Ph(n,e,t){const i=e._path,s=vt(n,e),r=Gr(n,t),o=n.listenProvider_.startListening(ct(e),s,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(i);if(s)p(!Te(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,f,d)=>{if(!N(c)&&f&&Te(f))return[on(f).query];{let u=[];return f&&(u=u.concat(Fr(f).map(m=>m.query))),Z(d,(m,g)=>{u=u.concat(g)}),u}});for(let c=0;c<l.length;++c){const f=l[c];n.listenProvider_.stopListening(ct(f),vt(n,f))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
