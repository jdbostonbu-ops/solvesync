 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cl=nl;function js(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const i=Object.assign({name:Pn,automaticDataCollectionEnabled:!0},e),s=i.name;if(typeof s!="string"||!s)throw we.create("bad-app-name",{appName:String(s)});if(t||(t=Ws()),!t)throw we.create("no-options");const r=Ut.get(s);if(r){if(Wt(t,r.options)&&Wt(i,r.config))return r;throw we.create("duplicate-app",{appName:s})}const o=new da(s);for(const l of Dn.values())o.addComponent(l);const a=new ll(t,i,o);return Ut.set(s,a),a}function hl(n=Pn){const e=Ut.get(n);if(!e&&n===Pn&&Ws())return js();if(!e)throw we.create("no-app",{appName:n});return e}function He(n,e,t){var i;let s=(i=il[n])!==null&&i!==void 0?i:n;t&&(s+=`-${t}`);const r=s.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${s}" with version "${e}":`];r&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),ye.warn(a.join(" "));return}Ht(new ft(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ul="firebase-heartbeat-database",dl=1,_t="firebase-heartbeat-store";let En=null;function qs(){return En||(En=Sa(ul,dl,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(_t)}catch(t){console.warn(t)}}}}).catch(n=>{throw we.create("idb-open",{originalErrorMessage:n.message})})),En}async function fl(n){try{const t=(await qs()).transaction(_t),i=await t.objectStore(_t).get(Ys(n));return await t.done,i}catch(e){if(e instanceof It)ye.warn(e.message);else{const t=we.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});ye.warn(t.message)}}}async function $i(n,e){try{const i=(await qs()).transaction(_t,"readwrite");await i.objectStore(_t).put(e,Ys(n)),await i.done}catch(t){if(t instanceof It)ye.warn(t.message);else{const i=we.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});ye.warn(i.message)}}}function Ys(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cl(n){Ht(new ft("platform-logger",e=>new Ra(e),"PRIVATE")),Ht(new ft("heartbeat",e=>new ml(e),"PRIVATE")),He(kn,Hi,n),He(kn,Hi,"esm2017"),He("fire-js","")}Cl("");var El="firebase",bl="11.10.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */He(El,bl,"app");var ji={};const qi="@firebase/database",Yi="1.0.20";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qs=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Il(e)}}catch{}return new Sl},Pe=Qs("localStorage"),Tl=Qs("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bn={},wn={};function Jn(n){const e=n.toString();return bn[e]||(bn[e]=new Vl),bn[e]}function $l(n,e){const t=n.toString();return wn[t]||(wn[t]=e()),wn[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ss=32,rs=768;class P{constructor(e,t){if(t===void 0){this.pieces_=e.split("/");let i=0;for(let s=0;s<this.pieces_.length;s++)this.pieces_[s].length>0&&(this.pieces_[i]=this.pieces_[s],i++);this.pieces_.length=i,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)this.pieces_[t]!==""&&(e+="/"+this.pieces_[t]);return e||"/"}}function k(){return new P("")}function S(n){return n.pieceNum_>=n.pieces_.length?null:n.pieces_[n.pieceNum_]}function Te(n){return n.pieces_.length-n.pieceNum_}function L(n){let e=n.pieceNum_;return e<n.pieces_.length&&e++,new P(n.pieces_,e)}function vr(n){return n.pieceNum_<n.pieces_.length?n.pieces_[n.pieces_.length-1]:null}function dc(n){let e="";for(let t=n.pieceNum_;t<n.pieces_.length;t++)n.pieces_[t]!==""&&(e+="/"+encodeURIComponent(String(n.pieces_[t])));return e||"/"}function Cr(n,e=0){return n.pieces_.slice(n.pieceNum_+e)}function Er(n){if(n.pieceNum_>=n.pieces_.length)return null;const e=[];for(let t=n.pieceNum_;t<n.pieces_.length-1;t++)e.push(n.pieces_[t]);return new P(e,0)}function $(n,e){const t=[];for(let i=n.pieceNum_;i<n.pieces_.length;i++)t.push(n.pieces_[i]);if(e instanceof P)for(let i=e.pieceNum_;i<e.pieces_.length;i++)t.push(e.pieces_[i]);else{const i=e.split("/");for(let s=0;s<i.length;s++)i[s].length>0&&t.push(i[s])}return new P(t,0)}function N(n){return n.pieceNum_>=n.pieces_.length}function Q(n,e){const t=S(n),i=S(e);if(t===null)return e;if(t===i)return Q(L(n),L(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+n+")")}function ei(n,e){if(Te(n)!==Te(e))return!1;for(let t=n.pieceNum_,i=e.pieceNum_;t<=n.pieces_.length;t++,i++)if(n.pieces_[t]!==e.pieces_[i])return!1;return!0}function he(n,e){let t=n.pieceNum_,i=e.pieceNum_;if(Te(n)>Te(e))return!1;for(;t<n.pieces_.length;){if(n.pieces_[t]!==e.pieces_[i])return!1;++t,++i}return!0}class fc{constructor(e,t){this.errorPrefix_=t,this.parts_=Cr(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let i=0;i<this.parts_.length;i++)this.byteLength_+=rn(this.parts_[i]);br(this)}}function _c(n,e){n.parts_.length>0&&(n.byteLength_+=1),n.parts_.push(e),n.byteLength_+=rn(e),br(n)}function pc(n){const e=n.parts_.pop();n.byteLength_-=rn(e),n.parts_.length>0&&(n.byteLength_-=1)}function br(n){if(n.byteLength_>rs)throw new Error(n.errorPrefix_+"has a key path longer than "+rs+" bytes ("+n.byteLength_+").");if(n.parts_.length>ss)throw new Error(n.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+ss+") or object contains a cycle "+ke(n))}function ke(n){return n.parts_.length===0?"":"in property '"+n.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class on{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const i=new T(qe,e),s=new T(qe,t);return this.compare(i,s)!==0}minPost(){return T.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let kt;class wr extends on{static get __EMPTY_NODE(){return kt}static set __EMPTY_NODE(e){kt=e}compare(e,t){return Je(e.name,t.name)}isDefinedOn(e){throw Qe("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return T.MIN}maxPost(){return new T(Oe,kt)}makePost(e,t){return p(typeof e=="string","KeyIndex indexValue must always be a string."),new T(e,kt)}toString(){return".key"}}const $e=new wr;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Fn;function bc(n){Fn=n}const Ir=function(n){return typeof n=="number"?"number:"+er(n):"string:"+n},Sr=function(n){if(n.isLeafNode()){const e=n.val();p(typeof e=="string"||typeof e=="number"||typeof e=="object"&&Ce(e,".sv"),"Priority must be a string or number.")}else p(n===Fn||n.isEmpty(),"priority of unexpected type.");p(n===Fn||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Tr,Nr;function wc(n){Tr=n}function Ic(n){Nr=n}class Sc extends on{compare(e,t){const i=e.node.getPriority(),s=t.node.getPriority(),r=i.compareTo(s);return r===0?Je(e.name,t.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return T.MIN}maxPost(){return new T(Oe,new z("[PRIORITY-POST]",Nr))}makePost(e,t){const i=Tr(e);return new T(t,new z("[PRIORITY-POST]",i))}toString(){return".priority"}}const H=new Sc;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tc=Math.log(2);class Nc{constructor(e){const t=r=>parseInt(Math.log(r)/Tc,10),i=r=>parseInt(Array(r+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const s=i(this.count);this.bits_=e+1&s}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const zt=function(n,e,t,i){n.sort(e);const s=function(l,c){const f=c-l;let d,u;if(f===0)return null;if(f===1)return d=n[l],u=t?t(d):d,new G(u,d.node,G.BLACK,null,null);{const m=parseInt(f/2,10)+l,g=s(l,m),M=s(m+1,c);return d=n[m],u=t?t(d):d,new G(u,d.node,G.BLACK,g,M)}},r=function(l){let c=null,f=null,d=n.length;const u=function(g,M){const b=d-g,se=d;d-=g;const re=s(b+1,se),oe=n[b],tt=t?t(oe):oe;m(new G(tt,oe.node,M,null,re))},m=function(g){c?(c.left=g,c=g):(f=g,c=g)};for(let g=0;g<l.count;++g){const M=l.nextBitIsOne(),b=Math.pow(2,l.count-(g+1));M?u(b,G.BLACK):(u(b,G.BLACK),u(b,G.RED))}return f},o=new Nc(n.length),a=r(o);return new J(i||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Sn;const We={};class me{static get Default(){return p(We&&H,"ChildrenNode.ts has not been loaded"),Sn=Sn||new me({".priority":We},{".priority":H}),Sn}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=je(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof J?t:null}hasIndex(e){return Ce(this.indexSet_,e.toString())}addIndex(e,t){p(e!==$e,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let s=!1;const r=t.getIterator(T.Wrap);let o=r.getNext();for(;o;)s=s||e.isDefinedOn(o.node),i.push(o),o=r.getNext();let a;s?a=zt(i,e.getCompare()):a=We;const l=e.toString(),c=Object.assign({},this.indexSet_);c[l]=e;const f=Object.assign({},this.indexes_);return f[l]=a,new me(f,c)}addToIndexes(e,t){const i=Bt(this.indexes_,(s,r)=>{const o=je(this.indexSet_,r);if(p(o,"Missing index implementation for "+r),s===We)if(o.isDefinedOn(e.node)){const a=[],l=t.getIterator(T.Wrap);let c=l.getNext();for(;c;)c.name!==e.name&&a.push(c),c=l.getNext();return a.push(e),zt(a,o.getCompare())}else return We;else{const a=t.get(e.name);let l=s;return a&&(l=l.remove(new T(e.name,a))),l.insert(e,e.node)}});return new me(i,this.indexSet_)}removeFromIndexes(e,t){const i=Bt(this.indexes_,s=>{if(s===We)return s;{const r=t.get(e.name);return r?s.remove(new T(e.name,r)):s}});return new me(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let st;class v{static get EMPTY_NODE(){return st||(st=new v(new J(ni),null,me.Default))}constructor(e,t,i){this.children_=e,this.priorityNode_=t,this.indexMap_=i,this.lazyHash_=null,this.priorityNode_&&Sr(this.priorityNode_),this.children_.isEmpty()&&p(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}isLeafNode(){return!1}getPriority(){return this.priorityNode_||st}updatePriority(e){return this.children_.isEmpty()?this:new v(this.children_,e,this.indexMap_)}getImmediateChild(e){if(e===".priority")return this.getPriority();{const t=this.children_.get(e);return t===null?st:t}}getChild(e){const t=S(e);return t===null?this:this.getImmediateChild(t).getChild(L(e))}hasChild(e){return this.children_.get(e)!==null}updateImmediateChild(e,t){if(p(t,"We should always be passing snapshot nodes"),e===".priority")return this.updatePriority(t);{const i=new T(e,t);let s,r;t.isEmpty()?(s=this.children_.remove(e),r=this.indexMap_.removeFromIndexes(i,this.children_)):(s=this.children_.insert(e,t),r=this.indexMap_.addToIndexes(i,this.children_));const o=s.isEmpty()?st:this.priorityNode_;return new v(s,o,r)}}updateChild(e,t){const i=S(e);if(i===null)return t;{p(S(e)!==".priority"||Te(e)===1,".priority must be the last token in a path");const s=this.getImmediateChild(i).updateChild(L(e),t);return this.updateImmediateChild(i,s)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let i=0,s=0,r=!0;if(this.forEachChild(H,(o,a)=>{t[o]=a.val(e),i++,r&&v.INTEGER_REGEXP_.test(o)?s=Math.max(s,Number(o)):r=!1}),!e&&r&&s<2*i){const o=[];for(const a in t)o[a]=t[a];return o}else return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(this.lazyHash_===null){let e="";this.getPriority().isEmpty()||(e+="priority:"+Ir(this.getPriority().val())+":"),this.forEachChild(H,(t,i)=>{const s=i.hash();s!==""&&(e+=":"+t+":"+s)}),this.lazyHash_=e===""?"":Xs(e)}return this.lazyHash_}getPredecessorChildName(e,t,i){const s=this.resolveIndex_(i);if(s){const r=s.getPredecessorKey(new T(e,t));return r?r.name:null}else return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const i=t.minKey();return i&&i.name}else return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new T(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const i=t.maxKey();return i&&i.name}else return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new T(t,this.children_.get(t)):null}forEachChild(e,t){const i=this.resolveIndex_(e);return i?i.inorderTraversal(s=>t(s.name,s.node)):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const i=this.resolveIndex_(t);if(i)return i.getIteratorFrom(e,s=>s);{const s=this.children_.getIteratorFrom(e.name,T.Wrap);let r=s.peek();for(;r!=null&&t.compare(r,e)<0;)s.getNext(),r=s.peek();return s}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const i=this.resolveIndex_(t);if(i)return i.getReverseIteratorFrom(e,s=>s);{const s=this.children_.getReverseIteratorFrom(e.name,T.Wrap);let r=s.peek();for(;r!=null&&t.compare(r,e)>0;)s.getNext(),r=s.peek();return s}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===Nt?-1:0}withIndex(e){if(e===$e||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new v(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===$e||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority()))if(this.children_.count()===t.children_.count()){const i=this.getIterator(H),s=t.getIterator(H);let r=i.getNext(),o=s.getNext();for(;r&&o;){if(r.name!==o.name||!r.node.equals(o.node))return!1;r=i.getNext(),o=s.getNext()}return r===null&&o===null}else return!1;else return!1}}resolveIndex_(e){return e===$e?null:this.indexMap_.get(e.toString())}}v.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;class Rc extends v{constructor(){super(new J(ni),v.EMPTY_NODE,me.Default)}compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return v.EMPTY_NODE}isEmpty(){return!1}}const Nt=new Rc;Object.defineProperties(T,{MIN:{value:new T(qe,v.EMPTY_NODE)},MAX:{value:new T(Oe,Nt)}});wr.__EMPTY_NODE=v.EMPTY_NODE;z.__childrenNodeConstructor=v;bc(Nt);Ic(Nt);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xc extends on{constructor(e){super(),this.indexPath_=e,p(!N(e)&&S(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const i=this.extractChild(e.node),s=this.extractChild(t.node),r=i.compareTo(s);return r===0?Je(e.name,t.name):r}makePost(e,t){const i=j(e),s=v.EMPTY_NODE.updateChild(this.indexPath_,i);return new T(t,s)}maxPost(){const e=v.EMPTY_NODE.updateChild(this.indexPath_,Nt);return new T(Oe,e)}toString(){return Cr(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mc extends on{compare(e,t){const i=e.node.compareTo(t.node);return i===0?Je(e.name,t.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return T.MIN}maxPost(){return T.MAX}makePost(e,t){const i=j(e);return new T(t,i)}toString(){return".value"}}const kc=new Mc;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gt extends gr{reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return t!==void 0?"tag$"+t:(p(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}constructor(e,t,i,s){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=i,this.appCheckTokenProvider_=s,this.log_=Tt("p:rest:"),this.listens_={}}listen(e,t,i,s){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const o=Gt.getListenId_(e,i),a={};this.listens_[o]=a;const l=cs(e._queryParams);this.restRequest_(r+".json",l,(c,f)=>{let d=f;if(c===404&&(d=null,c=null),c===null&&this.onDataUpdate_(r,d,!1,i),je(this.listens_,o)===a){let u;c?c===401?u="permission_denied":u="rest_error:"+c:u="ok",s(u,null)}})}unlisten(e,t){const i=Gt.getListenId_(e,t);delete this.listens_[i]}get(e){const t=cs(e._queryParams),i=e._path.toString(),s=new sn;return this.restRequest_(i+".json",t,(r,o)=>{let a=o;r===404&&(a=null,r=null),r===null?(this.onDataUpdate_(i,a,!1,null),s.resolve(a)):s.reject(new Error(a))}),s.promise}refreshAuthToken(e){}restRequest_(e,t={},i){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([s,r])=>{s&&s.accessToken&&(t.auth=s.accessToken),r&&r.token&&(t.ac=r.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+oa(t);this.log_("Sending REST request for "+o);const a=new XMLHttpRequest;a.onreadystatechange=()=>{if(i&&a.readyState===4){this.log_("REST Response for "+o+" received. status:",a.status,"response:",a.responseText);let l=null;if(a.status>=200&&a.status<300){try{l=dt(a.responseText)}catch{Z("Failed to parse JSON response for "+o+": "+a.responseText)}i(null,l)}else a.status!==401&&a.status!==404&&Z("Got unsuccessful REST response for "+o+" Status: "+a.status),i(a.status);i=null}},a.open("GET",o,!0),a.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ct{constructor(e,t,i){this.source=e,this.path=t,this.children=i,this.type=ue.MERGE}operationForChild(e){if(N(this.path)){const t=this.children.subtree(new P(e));return t.isEmpty()?null:t.value?new Le(this.source,k(),t.value):new Ct(this.source,k(),t)}else return p(S(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Ct(this.source,L(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Si{constructor(e,t,i,s){this._repo=e,this._path=t,this._queryParams=i,this._orderByCalled=s}get key(){return N(this._path)?null:vr(this._path)}get ref(){return new Ee(this._repo,this._path)}get _queryIdentifier(){const e=hs(this._queryParams),t=Qn(e);return t==="{}"?"default":t}get _queryObject(){return hs(this._queryParams)}isEqual(e){if(e=Xe(e),!(e instanceof Si))return!1;const t=this._repo===e._repo,i=ei(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return t&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+dc(this._path)}}class Ee extends Si{constructor(e,t){super(e,t,new si,!1)}get parent(){const e=Er(this._path);return e===null?null:new Ee(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class bt{constructor(e,t,i){this._node=e,this.ref=t,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new P(e),i=tn(this.ref,e);return new bt(this._node.getChild(t),i,H)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new bt(s,tn(this.ref,i),H)))}hasChild(e){const t=new P(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function te(n,e){return n=Xe(n),n._checkNotDeleted("ref"),e!==void 0?tn(n._root,e):n._root}function tn(n,e){return n=Xe(n),S(n._path)===null?Qh("child","path",e):no("child","path",e),new Ee(n._repo,$(n._path,e))}function ze(n,e){n=Xe(n),Xh("set",n._path),Kh("set",e,n._path);const t=new sn;return lu(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function fo(n){n=Xe(n);const e=new uo(()=>{}),t=new pn(e);return au(n._repo,n,t).then(i=>new bt(i,new Ee(n._repo,n._path),n._queryParams.getIndex()))}class pn{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const i=t._queryParams.getIndex();return new yu("value",this,new bt(e.snapshotNode,new Ee(t._repo,t._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new vu(this,e,t):null}matches(e){return e instanceof pn?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function Cu(n,e,t,i,s){let r;if(typeof i=="object"&&(r=void 0,s=i),typeof i=="function"&&(r=i),s&&s.onlyOnce){const l=t,c=(f,d)=>{Ss(n._repo,n,a),l(f,d)};c.userCallback=t.userCallback,c.context=t.context,t=c}const o=new uo(t,r||void 0),a=new pn(o);return hu(n._repo,n,a),()=>Ss(n._repo,n,a)}function Mt(n,e,t,i){return Cu(n,"value",e,t,i)}bh(Ee);Nh(Ee);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Eu="FIREBASE_DATABASE_EMULATOR_HOST",Gn={};let bu=!1;function wu(n,e,t,i){const s=e.lastIndexOf(":"),r=e.substring(0,s),o=qn(r);n.repoInfo_=new hr(e,o,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0,t),i&&(n.authTokenProvider_=i)}function Iu(n,e,t,i,s){let r=i||n.options.databaseURL;r===void 0&&(n.options.projectId||ve("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Y("Using default host for project ",n.options.projectId),r=`${n.options.projectId}-default-rtdb.firebaseio.com`);let o=Ts(r,s),a=o.repoInfo,l;typeof process<"u"&&ji&&(l=ji[Eu]),l?(r=`http://${l}?ns=${a.namespace}`,o=Ts(r,s),a=o.repoInfo):o.repoInfo.secure;const c=new Ul(n.name,n.options,e);Jh("Invalid Firebase Database URL",o),N(o.path)||ve("Database URL must point to the root of a Firebase Database (not including a child path).");const f=Tu(a,n,c,new Wl(n,t));return new Nu(f,n)}function Su(n,e){const t=Gn[e];(!t||t[n.key]!==n)&&ve(`Database ${e}(${n.repoInfo_}) has already been deleted.`),uu(n),delete t[n.key]}function Tu(n,e,t,i){let s=Gn[e.name];s||(s={},Gn[e.name]=s);let r=s[n.toURLString()];return r&&ve("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new iu(n,bu,t,i),s[n.toURLString()]=r,r}class Nu{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(su(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Ee(this._repo,k())),this._rootInternal}_delete(){return this._rootInternal!==null&&(Su(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&ve("Cannot call "+e+" on a deleted database.")}}function Ru(n=hl(),e){const t=rl(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const i=zo("database");i&&Au(t,...i)}return t}function Au(n,e,t,i={}){n=Xe(n),n._checkNotDeleted("useEmulator");const s=`${e}:${t}`,r=n._repoInternal;if(n._instanceStarted){if(s===n._repoInternal.repoInfo_.host&&Wt(i,r.repoInfo_.emulatorOptions))return;ve("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let o;if(r.repoInfo_.nodeAdmin)i.mockUserToken&&ve('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new Lt(Lt.OWNER);else if(i.mockUserToken){const a=typeof i.mockUserToken=="string"?i.mockUserToken:jo(i.mockUserToken,n.app.options.projectId);o=new Lt(a)}qn(e)&&(Go(e),Ko("Database",!0)),wu(r,s,i,o)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xu(n){wl(cl),Ht(new ft("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Iu(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),He(qi,Yi,n),He(qi,Yi,"esm2017")}ge.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};ge.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};xu();var Ti={};(function n(e,t,i,s){var r=!!(e.Worker&&e.Blob&&e.Promise&&e.OffscreenCanvas&&e.OffscreenCanvasRenderingContext2D&&e.HTMLCanvasElement&&e.HTMLCanvasElement.prototype.transferControlToOffscreen&&e.URL&&e.URL.createObjectURL),o=typeof Path2D=="function"&&typeof DOMMatrix=="function",a=function(){if(!e.OffscreenCanvas)return!1;try{var _=new OffscreenCanvas(1,1),h=_.getContext("2d");h.fillRect(0,0,1,1);var y=_.transferToImageBitmap();h.createPattern(y,"no-repeat")}catch{return!1}return!0}();function l(){}function c(_){var h=t.exports.Promise,y=h!==void 0?h:e.Promise;return typeof y=="function"?new y(_):(_(l,l),null)}var f=function(_,h){return{transform:function(y){if(_)return y;if(h.has(y))return h.get(y);var E=new OffscreenCanvas(y.width,y.height),w=E.getContext("2d");return w.drawImage(y,0,0),h.set(y,E),E},clear:function(){h.clear()}}}(a,new Map),d=function(){var _=Math.floor(16.666666666666668),h,y,E={},w=0;return typeof requestAnimationFrame=="function"&&typeof cancelAnimationFrame=="function"?(h=function(I){var R=Math.random();return E[R]=requestAnimationFrame(function C(A){w===A||w+_-1<A?(w=A,delete E[R],I()):E[R]=requestAnimationFrame(C)}),R},y=function(I){E[I]&&cancelAnimationFrame(E[I])}):(h=function(I){return setTimeout(I,_)},y=function(I){return clearTimeout(I)}),{frame:h,cancel:y}}(),u=function(){var _,h,y={};function E(w){function I(R,C){w.postMessage({options:R||{},callback:C})}w.init=function(C){var A=C.transferControlToOffscreen();w.postMessage({canvas:A},[A])},w.fire=function(C,A,D){if(h)return I(C,null),h;var W=Math.random().toString(36).slice(2);return h=c(function(F){function U(q){q.data.callback===W&&(delete y[W],w.removeEventListener("message",U),h=null,f.clear(),D(),F())}w.addEventListener("message",U),I(C,W),y[W]=U.bind(null,{data:{callback:W}})}),h},w.reset=function(){w.postMessage({reset:!0});for(var C in y)y[C](),delete y[C]}}return function(){if(_)return _;if(!i&&r){var w=["var CONFETTI, SIZE = {}, module = {};","("+n.toString()+")(this, module, true, SIZE);","onmessage = function(msg) {","  if (msg.data.options) {","    CONFETTI(msg.data.options).then(function () {","      if (msg.data.callback) {","        postMessage({ callback: msg.data.callback });","      }","    });","  } else if (msg.data.reset) {","    CONFETTI && CONFETTI.reset();","  } else if (msg.data.resize) {","    SIZE.width = msg.data.resize.width;","    SIZE.height = msg.data.resize.height;","  } else if (msg.data.canvas) {","    SIZE.width = msg.data.canvas.width;","    SIZE.height = msg.data.canvas.height;","    CONFETTI = module.exports.create(msg.data.canvas);","  }","}"].join(`
`);try{_=new Worker(URL.createObjectURL(new Blob([w])))}catch(I){return typeof console<"u"&&typeof console.warn=="function"&&console.warn("🎊 Could not load worker",I),null}E(_)}return _}}(),m={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function g(_,h){return h?h(_):_}function M(_){return _!=null}function b(_,h,y){return g(_&&M(_[h])?_[h]:m[h],y)}function se(_){return _<0?0:Math.floor(_)}function re(_,h){return Math.floor(Math.random()*(h-_))+_}function oe(_){return parseInt(_,16)}function tt(_){return _.map(_o)}function _o(_){var h=String(_).replace(/[^0-9a-f]/gi,"");return h.length<6&&(h=h[0]+h[0]+h[1]+h[1]+h[2]+h[2]),{r:oe(h.substring(0,2)),g:oe(h.substring(2,4)),b:oe(h.substring(4,6))}}function po(_){var h=b(_,"origin",Object);return h.x=b(h,"x",Number),h.y=b(h,"y",Number),h}function mo(_){_.width=document.documentElement.clientWidth,_.height=document.documentElement.clientHeight}function go(_){var h=_.getBoundingClientRect();_.width=h.width,_.height=h.height}function yo(_){var h=document.createElement("canvas");return h.style.position="fixed",h.style.top="0px",h.style.left="0px",h.style.pointerEvents="none",h.style.zIndex=_,h}function vo(_,h,y,E,w,I,R,C,A){_.save(),_.translate(h,y),_.rotate(I),_.scale(E,w),_.arc(0,0,1,R,C,A),_.restore()}function Co(_){var h=_.angle*(Math.PI/180),y=_.spread*(Math.PI/180);return{x:_.x,y:_.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:_.startVelocity*.5+Math.random()*_.startVelocity,angle2D:-h+(.5*y-Math.random()*y),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:_.color,shape:_.shape,tick:0,totalTicks:_.ticks,decay:_.decay,drift:_.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:_.gravity*3,ovalScalar:.6,scalar:_.scalar,flat:_.flat}}function Eo(_,h){h.x+=Math.cos(h.angle2D)*h.velocity+h.drift,h.y+=Math.sin(h.angle2D)*h.velocity+h.gravity,h.velocity*=h.decay,h.flat?(h.wobble=0,h.wobbleX=h.x+10*h.scalar,h.wobbleY=h.y+10*h.scalar,h.tiltSin=0,h.tiltCos=0,h.random=1):(h.wobble+=h.wobbleSpeed,h.wobbleX=h.x+10*h.scalar*Math.cos(h.wobble),h.wobbleY=h.y+10*h.scalar*Math.sin(h.wobble),h.tiltAngle+=.1,h.tiltSin=Math.sin(h.tiltAngle),h.tiltCos=Math.cos(h.tiltAngle),h.random=Math.random()+2);var y=h.tick++/h.totalTicks,E=h.x+h.random*h.tiltCos,w=h.y+h.random*h.tiltSin,I=h.wobbleX+h.random*h.tiltCos,R=h.wobbleY+h.random*h.tiltSin;if(_.fillStyle="rgba("+h.color.r+", "+h.color.g+", "+h.color.b+", "+(1-y)+")",_.beginPath(),o&&h.shape.type==="path"&&typeof h.shape.path=="string"&&Array.isArray(h.shape.matrix))_.fill(wo(h.shape.path,h.shape.matrix,h.x,h.y,Math.abs(I-E)*.1,Math.abs(R-w)*.1,Math.PI/10*h.wobble));else if(h.shape.type==="bitmap"){var C=Math.PI/10*h.wobble,A=Math.abs(I-E)*.1,D=Math.abs(R-w)*.1,W=h.shape.bitmap.width*h.scalar,F=h.shape.bitmap.height*h.scalar,U=new DOMMatrix([Math.cos(C)*A,Math.sin(C)*A,-Math.sin(C)*D,Math.cos(C)*D,h.x,h.y]);U.multiplySelf(new DOMMatrix(h.shape.matrix));var q=_.createPattern(f.transform(h.shape.bitmap),"no-repeat");q.setTransform(U),_.globalAlpha=1-y,_.fillStyle=q,_.fillRect(h.x-W/2,h.y-F/2,W,F),_.globalAlpha=1}else if(h.shape==="circle")_.ellipse?_.ellipse(h.x,h.y,Math.abs(I-E)*h.ovalScalar,Math.abs(R-w)*h.ovalScalar,Math.PI/10*h.wobble,0,2*Math.PI):vo(_,h.x,h.y,Math.abs(I-E)*h.ovalScalar,Math.abs(R-w)*h.ovalScalar,Math.PI/10*h.wobble,0,2*Math.PI);else if(h.shape==="star")for(var x=Math.PI/2*3,X=4*h.scalar,ae=8*h.scalar,le=h.x,pe=h.y,xe=5,fe=Math.PI/xe;xe--;)le=h.x+Math.cos(x)*ae,pe=h.y+Math.sin(x)*ae,_.lineTo(le,pe),x+=fe,le=h.x+Math.cos(x)*X,pe=h.y+Math.sin(x)*X,_.lineTo(le,pe),x+=fe;else _.moveTo(Math.floor(h.x),Math.floor(h.y)),_.lineTo(Math.floor(h.wobbleX),Math.floor(w)),_.lineTo(Math.floor(I),Math.floor(R)),_.lineTo(Math.floor(E),Math.floor(h.wobbleY));return _.closePath(),_.fill(),h.tick<h.totalTicks}function bo(_,h,y,E,w){var I=h.slice(),R=_.getContext("2d"),C,A,D=c(function(W){function F(){C=A=null,R.clearRect(0,0,E.width,E.height),f.clear(),w(),W()}function U(){i&&!(E.width===s.width&&E.height===s.height)&&(E.width=_.width=s.width,E.height=_.height=s.height),!E.width&&!E.height&&(y(_),E.width=_.width,E.height=_.height),R.clearRect(0,0,E.width,E.height),I=I.filter(function(q){return Eo(R,q)}),I.length?C=d.frame(U):F()}C=d.frame(U),A=F});return{addFettis:function(W){return I=I.concat(W),D},canvas:_,promise:D,reset:function(){C&&d.cancel(C),A&&A()}}}function Ri(_,h){var y=!_,E=!!b(h||{},"resize"),w=!1,I=b(h,"disableForReducedMotion",Boolean),R=r&&!!b(h||{},"useWorker"),C=R?u():null,A=y?mo:go,D=_&&C?!!_.__confetti_initialized:!1,W=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,F;function U(x,X,ae){for(var le=b(x,"particleCount",se),pe=b(x,"angle",Number),xe=b(x,"spread",Number),fe=b(x,"startVelocity",Number),To=b(x,"decay",Number),No=b(x,"gravity",Number),Ro=b(x,"drift",Number),xi=b(x,"colors",tt),Ao=b(x,"ticks",Number),Mi=b(x,"shapes"),xo=b(x,"scalar"),Mo=!!b(x,"flat"),ki=po(x),Pi=le,gn=[],ko=_.width*ki.x,Po=_.height*ki.y;Pi--;)gn.push(Co({x:ko,y:Po,angle:pe,spread:xe,startVelocity:fe,color:xi[Pi%xi.length],shape:Mi[re(0,Mi.length)],ticks:Ao,decay:To,gravity:No,drift:Ro,scalar:xo,flat:Mo}));return F?F.addFettis(gn):(F=bo(_,gn,A,X,ae),F.promise)}function q(x){var X=I||b(x,"disableForReducedMotion",Boolean),ae=b(x,"zIndex",Number);if(X&&W)return c(function(fe){fe()});y&&F?_=F.canvas:y&&!_&&(_=yo(ae),document.body.appendChild(_)),E&&!D&&A(_);var le={width:_.width,height:_.height};C&&!D&&C.init(_),D=!0,C&&(_.__confetti_initialized=!0);function pe(){if(C){var fe={getBoundingClientRect:function(){if(!y)return _.getBoundingClientRect()}};A(fe),C.postMessage({resize:{width:fe.width,height:fe.height}});return}le.width=le.height=null}function xe(){F=null,E&&(w=!1,e.removeEventListener("resize",pe)),y&&_&&(document.body.contains(_)&&document.body.removeChild(_),_=null,D=!1)}return E&&!w&&(w=!0,e.addEventListener("resize",pe,!1)),C?C.fire(x,le,xe):U(x,le,xe)}return q.reset=function(){C&&C.reset(),F&&F.reset()},q}var mn;function Ai(){return mn||(mn=Ri(null,{useWorker:!0,resize:!0})),mn}function wo(_,h,y,E,w,I,R){var C=new Path2D(_),A=new Path2D;A.addPath(C,new DOMMatrix(h));var D=new Path2D;return D.addPath(A,new DOMMatrix([Math.cos(R)*w,Math.sin(R)*w,-Math.sin(R)*I,Math.cos(R)*I,y,E])),D}function Io(_){if(!o)throw new Error("path confetti are not supported in this browser");var h,y;typeof _=="string"?h=_:(h=_.path,y=_.matrix);var E=new Path2D(h),w=document.createElement("canvas"),I=w.getContext("2d");if(!y){for(var R=1e3,C=R,A=R,D=0,W=0,F,U,q=0;q<R;q+=2)for(var x=0;x<R;x+=2)I.isPointInPath(E,q,x,"nonzero")&&(C=Math.min(C,q),A=Math.min(A,x),D=Math.max(D,q),W=Math.max(W,x));F=D-C,U=W-A;var X=10,ae=Math.min(X/F,X/U);y=[ae,0,0,ae,-Math.round(F/2+C)*ae,-Math.round(U/2+A)*ae]}return{type:"path",path:h,matrix:y}}function So(_){var h,y=1,E="#000000",w='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof _=="string"?h=_:(h=_.text,y="scalar"in _?_.scalar:y,w="fontFamily"in _?_.fontFamily:w,E="color"in _?_.color:E);var I=10*y,R=""+I+"px "+w,C=new OffscreenCanvas(I,I),A=C.getContext("2d");A.font=R;var D=A.measureText(h),W=Math.ceil(D.actualBoundingBoxRight+D.actualBoundingBoxLeft),F=Math.ceil(D.actualBoundingBoxAscent+D.actualBoundingBoxDescent),U=2,q=D.actualBoundingBoxLeft+U,x=D.actualBoundingBoxAscent+U;W+=U+U,F+=U+U,C=new OffscreenCanvas(W,F),A=C.getContext("2d"),A.font=R,A.fillStyle=E,A.fillText(h,q,x);var X=1/y;return{type:"bitmap",bitmap:C.transferToImageBitmap(),matrix:[X,0,0,X,-W*X/2,-F*X/2]}}t.exports=function(){return Ai().apply(this,arguments)},t.exports.reset=function(){Ai().reset()},t.exports.create=Ri,t.exports.shapeFromPath=Io,t.exports.shapeFromText=So})(function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}}(),Ti,!1);const wt=Ti.exports;Ti.exports.create;async function Mu(n){const t="https://googleapis.com/v1/text:synthesize?key=undefined",i={input:{text:n},voice:{languageCode:"en-US",name:"en-US-Neural2-F"},audioConfig:{audioEncoding:"MP3"}};try{const r=await(await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(i)})).json(),o=ku(r.audioContent,"audio/mp3"),a=URL.createObjectURL(o),l=new Audio(a);console.log("🔊 SolveSync is reading..."),await l.play()}catch(s){console.error("TTS Error:",s)}}function ku(n,e){const t=atob(n),i=[];for(let s=0;s<t.length;s++)i.push(t.charCodeAt(s));return new Blob([new Uint8Array(i)],{type:e})}let ie=0;const Pu={apiKey:"AIzaSyCDKY-SQ4mOtNUMp124NgSUiZnV6vglW4A",authDomain:"solvesync-6f45a.firebaseapp.com",databaseURL:"https://solvesync-6f45a-default-rtdb.firebaseio.com",projectId:"solvesync-6f45a",storageBucket:"solvesync-6f45a.appspot.com",messagingSenderId:"...",appId:"..."},Du=js(Pu),ne=Ru(Du),Ae=document.getElementById("answer-input"),K=document.getElementById("student-work"),Ns=document.getElementById("clear-btn"),Ou=document.getElementById("connection-status"),Lu=document.getElementById("status-dot"),Rs=document.getElementById("math-problem"),nn=document.getElementById("submit-btn"),As=document.getElementById("hint-btn"),Dt=document.getElementById("chalkboard"),Ot=document.getElementById("streak-num"),xs=document.getElementById("next-btn"),Ms=document.getElementById("high-score-num");let ks=0;Mt(te(ne,".info/connected"),n=>{n.val()===!0&&(Ou.innerText="CLOUD_SYNC_ACTIVE",Lu.style.background="#22c55e")});Mt(te(ne,"activeProblem"),n=>{const e=n.val();Rs&&(Rs.innerText=e||"Select a category below to start!")});Mt(te(ne,"worldRecord"),n=>{const e=n.val()||0;Ms&&(Ms.innerText=e)});Ae&&K&&(Ae.addEventListener("input",n=>{ze(te(ne,"currentWork"),n.target.value)}),Mt(te(ne,"currentWork"),n=>{K.innerText=n.val()||"READY_FOR_INPUT"}));Ns&&Ns.addEventListener("click",()=>{ze(te(ne,"currentWork"),""),Ae.value=""});let Ge="add";document.querySelectorAll(".cat-btn").forEach(n=>{n.addEventListener("click",e=>{const t=e.target.getAttribute("data-type");t&&(Ge=t,Ni(Ge))})});xs&&xs.addEventListener("click",()=>{Ge||(Ge="add"),Ni(Ge),K&&(K.innerText="")});function Ni(n){let e=Math.floor(Math.random()*20)+1,t=Math.floor(Math.random()*10)+1,i="",s=0;if(n==="add")i=`${e} + ${t} = ?`,s=e+t;else if(n==="sub")i=`${e+t} - ${t} = ?`,s=e;else if(n==="mult")i=`${e} × ${t} = ?`,s=e*t;else if(n==="div"){let r=Math.floor(Math.random()*50)+10,o=Math.floor(Math.random()*20)+2;i=`${r*o} ÷ ${o} = ?`,s=r}else if(n==="alg"){let r=Math.floor(Math.random()*15)+2,o=Math.floor(Math.random()*3);if(o===0){let a=Math.floor(Math.random()*5)+2,l=Math.floor(Math.random()*10)+1,c=a*(r+l);i=`Solve for x: ${a}(x + ${l}) = ${c}`,s=r}else if(o===1){let a=Math.floor(Math.random()*4)+1,l=a+(Math.floor(Math.random()*5)+2),c=Math.floor(Math.random()*20)+1,f=l*r+c-a*r;i=`Solve for x: ${l}x + ${c} = ${a}x + ${f}`,s=r}else{let a=Math.floor(Math.random()*8)+3,l=Math.floor(Math.random()*6)+2,c=a*r/l;for(;c%1!==0;)r++,c=a*r/l;i=`Solve for x: (${a}x) / ${l} = ${c}`,s=r}}ze(te(ne,"activeProblem"),i),ze(te(ne,"correctAnswer"),s),ze(te(ne,"currentWork"),""),Ae&&(Ae.value="")}function Ps(n){const e=document.getElementById("math-bot"),t=document.getElementById("bot-bubble"),i=document.getElementById("cosmo-rocket"),s=document.getElementById("cosmo-bubble"),r=document.getElementById("chalkboard");if(n%5===0){if(!i||!s)return;i.style.transition="bottom 1s ease-out",i.style.bottom="120px",s.style.display="block",r&&r.classList.add("shake-screen"),setTimeout(()=>{wt({particleCount:60,spread:80,origin:{x:.5,y:.8},colors:["#4b5563","#ff4500"]}),setTimeout(()=>{i.style.transition="bottom 5s cubic-bezier(0.1, 0, 1, 1)",i.style.bottom="180%";const o=Date.now()+4500;(function a(){wt({particleCount:12,angle:270,spread:45,origin:{x:.5,y:.5},colors:["#ff4500","#ffa500","#ffff00"],gravity:2}),Date.now()<o&&requestAnimationFrame(a)})()},1500)},500),setTimeout(()=>{s.style.display="none",r&&r.classList.remove("shake-screen"),i.style.transition="none",i.style.bottom="-400px"},7500)}else if(n%3===0){if(!e||!t)return;e.style.bottom="80px",e.classList.add("bot-dancing"),t.style.display="block",setTimeout(()=>{e.style.bottom="-450px",t.style.display="none",e.classList.remove("bot-dancing")},4500)}}function Fu(){const n=document.getElementById("persistence-banner");n&&setTimeout(()=>{n.style.top="50px",n.style.opacity="1";const t=Date.now()+4e3;(function i(){wt({particleCount:3,angle:60,spread:55,origin:{x:0,y:.3},colors:["#f0abfc","#fbbf24","#ffffff"]}),wt({particleCount:3,angle:120,spread:55,origin:{x:1,y:.3},colors:["#f0abfc","#fbbf24","#ffffff"]}),Date.now()<t&&requestAnimationFrame(i)})(),setTimeout(()=>{n.style.top="20px",n.style.opacity="0",n.style.filter="blur(10px)",setTimeout(()=>{n.style.top="-100px",n.style.filter="blur(0px)"},1e3)},4e3)},8500)}nn&&nn.addEventListener("click",()=>{const n=Ae.value.trim(),e=Number(n);Mt(te(ne,"correctAnswer"),t=>{const i=Number(t.val());e===i&&n!==""?(ie+=1,Ot&&(Ot.innerText=ie),(ie>0&&ie%5===0||ie===3)&&Ps(ie),fo(tn(te(ne),"worldRecord")).then(s=>{const r=s.val()||0;ie>r&&(ze(te(ne,"worldRecord"),ie),console.log("🏆 NEW WORLD RECORD!"))}),wt({particleCount:150,spread:70,origin:{y:.6},colors:["#22d3ee","#f8fafc","#334155"]}),Dt.classList.add("success-glow"),K.style.color="var(--accent-cyan)",ie>=3&&(Dt.style.boxShadow="0 0 50px var(--accent-cyan)"),setTimeout(()=>{alert(`CORRECT! 🚀 STREAK: ${ie}`),Dt.classList.remove("success-glow"),Ae.value="",Ni(Ge)},500)):(ie=0,Ot&&(Ot.innerText="0"),Dt.style.boxShadow="none",K.style.color="var(--danger-red)",alert("TRY AGAIN... ❌ STREAK RESET"))},{onlyOnce:!0})});nn&&nn.addEventListener("click",()=>{Ae.value.trim()!==""&&(ks++,ks%10===0&&Fu())});As&&As.addEventListener("click",async n=>{n.stopPropagation(),K.innerText="Analyzing problem and generating steps...";const e=te(ne,"activeProblem");try{const i=(await fo(e)).val();if(console.log("Sending to AI:",i),!i){K.innerText="NEW_PROBLEM_LOADED",K.style.color="var(--chalk-text)",K.innerText="Please select a math problem first!";return}const l=await(await fetch("https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=AIzaSyCyKTyxthpJS0MSYYYLFE6_XLECN3jR5RA",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:`Act as a 4th-8th grade math tutor. Solve this problem: "${i}". 
...
`+u,Mu(u)}else l.error&&l.error.code===429?(K.innerText="The tutor is busy. Please wait 60 seconds and try again!",K.style.color="var(--danger-red)"):K.innerText="Oops! Something went wrong. Try again."}catch(t){console.error("AI/Firebase Error:",t),K.innerText="Oops! I hit a snag. Try clicking hint again."}});
